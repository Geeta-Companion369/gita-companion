// ─── ANTIM YATRA — FINAL JOURNEY DATA ───────────────────────────────────────
// ACCURACY IS CRITICAL — sacred information for families in grief.
// All information sourced from Vedic tradition, Garuda Purana, and Gita.

export interface AntyestiSamagriItem {
  item: string;
  hindiName: string;
  purpose: string;
  quantity: string;
...
export interface AntyestiPhase {
  phase: string;
  icon: string;
  steps: AntyestiStep[];
}
...
export interface GarudaTeaching {
  title: string;
  description: string;
  gitaRef?: string;
  gitaSanskrit?: string;
...
export interface PitruPakshaInfo {
  title: string;
  content: string;
  icon: string;
}
...
export interface SoulVerse {
  ...
  meaning: string;
  forFamilyMeaning: string;
  krishnaSpeak: string;
}

export interface PindDaanStep {
  step: number;
  title: string;
  details: string;
  mantra?: string;
...
export interface SacredRiverInfo {
  name: string;
  hindiName: string;
  location: string;
  significance: string;
...
export interface VarshikShradhInfo {
  title: string;
  content: string;
  icon: string;
}
...
export const ANTYESTI_SAMAGRI: AntyestiSamagriItem[] = [
  ...
  },
  {
    ...
    purpose:
      "Placed in the mouth of the deceased at the moment of death. Tulsi is the most sacred plant — Vishnu's beloved. Her presence at the final moment opens the path to liberation. A garland of tulsi is also placed around the body during the final rites.",
  ...
  },
  {
    ...
    purpose:
      "Pure cow ghee offered into the sacred fire (havan) and the pyre with each mantra recitation. Each ghee offering (called 'ahuti') sends nourishment directly to the departing soul. Ghee is also used to anoint the body and is mixed with the pinda rice for pind daan.",
  ...
  },
  {
    ...
    hindiName: "चंदन",
    purpose:
      "Sandalwood paste applied on the forehead (tilak), chest, and hands of the deceased. Sandalwood pieces are placed on the pyre. Vishnu is particularly pleased by sandalwood — its use at this rite ensures divine favour for the departing soul. The fragrance purifies the entire space.",
  ...
  },
  {
    ...
    purpose:
      "Considered the most auspicious wood for the pyre. Its fragrant fire is purifying and beloved by Vishnu. When complete sandalwood is unaffordable, at minimum a few sandalwood pieces should be placed over the body on the pyre.",
  ...
  },
  {
    ...
    purpose:
      "The primary structural wood of the funeral pyre — the most traditional and widely used. Mango wood burns well and is considered sacred in Vedic tradition. It forms the main structure of the Chita (pyre).",
  ...
  },
  {
    ...
    purpose:
      "Peepal (sacred fig) wood is used in the inner layer of the pyre nearest the body. Peepal is the tree of Vishnu — using its wood is auspicious and liberating for the soul.",
  ...
  },
  {
    ...
    purpose:
      "New, clean white cloth to wrap the body fully. White represents purity and the soul's return to divine light. For a woman whose husband is living (suhagan), red or yellow cloth is traditional — she goes as a bride to the divine. For widows: white only. The cloth must never have been previously worn.",
  ...
  },
  {
    ...
    purpose:
      "Used for the ritual seat (karta sits on kusha grass for purity), as a ritual instrument for tarpana, for making the pind daan surface, and mixed into the tarpana water. Kusha is the most sacred grass in Vedic tradition — mentioned in the Gita itself (6.11) as the seat of meditation.",
  ...
  },
  {
    ...
    hindiName: "पंच फल",
    purpose:
      "Coconut (representing the skull), banana, mango, guava, and one seasonal fruit — offered during the rites as sustenance for the soul's journey. The coconut is given special importance and is placed on the body.",
  ...
  },
  {
    ...
    purpose:
      "Unbroken rice mixed with turmeric and kumkum for puja offerings. Also cooked plain rice (no salt, no oil) is essential for making the pindas (rice balls) for the 13-day pind daan.",
  ...
  },
  {
    ...
    hindiName: "जौ",
    purpose:
      "Barley flour is mixed with rice to make the pindas. According to the Garuda Purana, barley has special power to nourish the subtle body of the departing soul during the 13-day journey.",
  ...
  },
  {
    ...
    hindiName: "शहद",
    purpose:
      "Pure honey is mixed into the pindas (rice balls). Honey represents the sweetness of life and is one of the five traditional ingredients in pindas alongside rice, til, barley, and ghee.",
  ...
  },
  {
    ...
    purpose:
      "Copper is the most sacred metal in Vedic tradition — purifying, spiritually conductive, and free from impurity. All water offerings (tarpana) must be made from a copper vessel. Never use steel or plastic for sacred water offerings.",
  ...
  },
  {
    ...
    purpose:
      "Sandalwood incense is lit throughout the rites, purifying the space and creating a sacred atmosphere. Camphor (kapoor) is lit for the aarti and waved near the body. Incense should burn continuously for 13 days at the photo of the deceased.",
  ...
  },
  {
    ...
    purpose:
      "A clay diya filled with cow ghee (or sesame oil) is lit at the head of the deceased at the moment of death and must burn continuously for 13 days. This sacred flame guides the departing soul and is the single most important ritual light of the entire mourning period. Never let it go out.",
  ...
  },
  {
    ...
    purpose:
      "Flowers adorn the body and the bier (arthi). Marigold garlands are traditional. White flowers (jasmine, white roses) symbolise purity of the departing soul. Flowers are the language of love when words cannot reach.",
  ...
  },
  {
    ...
    purpose:
      "Mixed with akshata (rice) for all ritual offerings. Also applied with sandalwood paste to the body as a final purification. Turmeric is antiseptic and sacred — its yellow colour symbolises the auspiciousness of the soul's journey.",
    quantity: "100g each",
  },
  {
    ...
    purpose:
      "Used for the continuous diya (lamp) during the 13-day period. Also used for body massage during preparation. Sesame oil is connected to the ancestors in Vedic tradition.",
    quantity: "500ml",
  },
  {
    ...
    hindiName: "जनेऊ",
    purpose:
      "For those who wear the sacred thread (Brahmins, Kshatriyas, Vaishyas) — a new janeu is placed on the body. The karta also wears a fresh janeu for the ceremony. Symbolises the soul's sacred identity and Vedic status.",
  ...
  },
  {
    ...
    purpose:
      "Applied to the forehead of the deceased with a final tilak — three horizontal lines for Shaiva tradition, 'U' mark for Vaishnava. Vibhuti is the symbol of Shiva and represents the ultimate truth: all becomes ash, and from ash comes rebirth.",
    quantity: "One packet",
  },
  {
    ...
    purpose:
      "The funeral bier made of bamboo on which the body is carried to the cremation ground. Bamboo is used because it is considered pure — it grows from a single node (like the soul's continuity). The body must never touch the ground during the procession.",
  ...
  },
  {
    ...
    hindiName: "पंच धान्य",
    purpose:
      "Wheat, rice, chickpeas, urad dal, and lentils — representing the five elements of creation. A small amount is placed with the body and offered in pind daan. The five grains sustain the soul's journey as they sustained the body's life.",
  ...
  },
  {
    ...
    hindiName: "उपले / कंडे",
    purpose:
      "Dry cow dung cakes are used as additional fuel in the pyre — especially around the outer edges. Cow dung is considered supremely purifying in Vedic tradition. Burning it alongside the body purifies the space and is deeply auspicious.",
...
export const ANTYESTI_PHASES: AntyestiPhase[] = [
  {
    ...
    steps: [
      {
        ...
        details:
          "The very first act after the soul departs is to close the eyes of the deceased gently with the right hand. Say softly: 'Go in peace, beloved. Your journey was sacred. Krishna is waiting.' This is an act of profound love. The body is now a sacred vessel that housed an eternal soul — treat it with utmost reverence.",
      ...
      },
      {
        ...
        details:
          "Immediately recite the Maha Mantra softly and repeatedly close to the ear of the deceased. The Garuda Purana confirms that the soul lingers near the body for some time after death — it can hear. These divine names are the greatest gift you can give right now. Chant with love, not with ritual formality.",
      ...
      },
      {
        ...
        details:
          "Light a clay diya filled with cow ghee or pure sesame oil immediately near the head of the departed. This flame must be kept burning continuously for 13 full days. It guides the departing soul through the transition and protects the sacred space. Do not let it go out — if it does, relight it immediately with a prayer. This is the single most important ritual flame of the entire mourning period.",
      },
      {
        step: 5,
        title: "Position the Body on the Earth",
        details:
          "Place the body on the floor (on a clean mat or cloth — never on a bed after death). Place with the head facing North (Uttarayana — toward the divine realm) or East (toward the rising sun). The floor symbolises the body's return to the earth which gave it birth. This positioning is important for the subtle body's transition. Do not leave the body unattended at any time.",
      },
      {
        step: 6,
      ...
      },
      {
        ...
        details:
          "Read aloud from the Bhagavad Gita, beginning with Chapter 2, Verse 20. This verse is the greatest truth about the soul's eternal nature and brings immense peace to both the departing soul and the family present. Continue reading Chapter 2 in full if possible — this is considered a supremely auspicious act.",
        mantra:
      ...
      },
      {
        ...
        details:
          "Inform all family members immediately — especially the eldest son or nearest male relative (the karta who will perform the last rites). Contact a qualified Vedic pandit as soon as possible. Per Vedic tradition, the body should not remain for more than 24 hours without beginning the preparation process. In summer, preparations should begin as soon as possible. The pandit will guide the entire sequence with accuracy.",
      },
      {
        step: 9,
    ...
    steps: [
      {
        ...
        details:
          "The eldest son (or nearest male relative — the karta) leads the procession barefoot. The karta carries a clay pot with burning coal or a coconut with burning camphor on his shoulder — this is the 'mukhagni fire' which will light the pyre. He walks barefoot as a sign of humility and sacred duty. It is the greatest act of a son — guiding his parent's soul to liberation.",
      },
      {
        step: 2,
        title: "Carrying the Bier",
        details:
          "The body is carried on the shoulders of male relatives and close friends, taking turns, heads to the right. The bier must never touch the ground during the entire procession. It is an honour to carry the bier — those who do so perform an act of great merit (punya). The eldest son walks ahead; other sons and relatives walk alongside.",
      },
      {
        step: 3,
        title: "Chanting Throughout the Procession",
        details:
          "The entire procession chants continuously and aloud: 'Ram Naam Satya Hai' — the name of Ram is the only truth. This chanting creates a sacred sound corridor for the departing soul. Passersby who hear this chanting are also blessed. The procession moves with dignity, not haste. Women traditionally walk behind.",
        mantra: "राम नाम सत्य है। राम नाम सत्य है॥",
        mantraTranslit:
          "Rāma Nāma Satya Hai. Rāma Nāma Satya Hai. — The name of Ram is the only Truth.",
      },
      {
        step: 4,
    ...
    steps: [
      {
        ...
        details:
          "The eldest son (karta) takes a purifying bath (or is purified with water poured over him). He wears a single white dhoti, applied tilak, and ties kusha (darbha) grass around his right ring finger. He is now the sacred instrument of his parent's liberation. The weight of this moment is immense — and the privilege is equal to it.",
      },
      {
        step: 2,
        title: "Circumambulation with the Sacred Fire Pot",
        details:
          "The karta carries the earthen pot with burning fire (or burning camphor in a coconut half) on his left shoulder. He holds a small hole-bored water pot that drips water as he walks. He circumambulates the pyre three times in the counter-clockwise (apradakshina — against the usual clockwise direction). This counter-clockwise movement symbolises the reversal of life's direction, the departure from the normal cycle.",
        mantra: "ॐ यमाय नमः। ॐ धर्मराजाय नमः। ॐ मृत्यवे नमः॥",
        mantraTranslit:
          "Om Yamāya Namaḥ. Om Dharmarājāya Namaḥ. Om Mṛtyave Namaḥ.",
      },
      {
        step: 3,
        title: "Breaking the Water Pot",
        details:
          "At the end of the third circumambulation, the karta drops the water pot behind him so it breaks. He does not look back. This act of 'not looking back' is profoundly symbolic — the living must not cling to the dead; the dead must not cling to the living. The breaking of the pot is the final severing of earthly bonds. After this moment, the soul is fully released to continue its journey.",
      },
      {
        step: 4,
        title: "Lighting the Pyre — Mukhagni",
        details:
          "The karta touches the sacred flame to the pyre, beginning at the mouth region (mukha = mouth — hence Mukhagni). He recites the final mantra as the fire takes hold. In the Kapal Kriya tradition (performed in certain communities), the eldest son touches the skull region with a bamboo staff at the appointed moment to release the soul from the body — this is done only when and if the priest indicates. This act, though difficult, is considered the highest act of filial devotion.",
        mantra: "ॐ अग्ने नय सुपथा राये अस्मान् विश्वानि देव वयुनानि विद्वान्॥",
        mantraTranslit:
          "Om Agne Naya Supathā Rāye Asmān Viśvāni Deva Vayunāni Vidvān — O Agni, lead us to the good path toward prosperity, O God who knows all our deeds.",
      },
      {
        step: 5,
        title: "Ghee and Sesame Oblations",
        details:
          "As the fire takes hold, the karta pours ghee into the flames using a ladle (sruk or spoon), followed by offerings of black sesame seeds. Each offering is accompanied by a mantra ending in 'Svāhā' — the Vedic equivalent of 'This is offered to you.' These oblations are spiritual nourishment sent directly to the departing soul.",
        mantra:
          "ॐ भूः स्वाहा। इदम् अग्नये इदं न मम॥\nॐ भुवः स्वाहा। इदम् वायवे इदं न मम॥\nॐ स्वः स्वाहा। इदम् सूर्याय इदं न मम॥",
        mantraTranslit:
          "Om Bhūḥ Svāhā. Idam Agnaye Idaṁ Na Mama.\nOm Bhuvaḥ Svāhā. Idam Vāyave Idaṁ Na Mama.\nOm Svaḥ Svāhā. Idam Sūryāya Idaṁ Na Mama.",
      },
      {
        step: 6,
        title: "Sacred Recitation During the Fire",
        details:
          "While the fire burns, the assembled family and priest recite Bhagavad Gita Chapter 2 continuously — the verses on the eternal nature of the soul. Chapter 15 (Purushottama Yoga) is also recited. Continuous chanting of 'Hare Krishna' or 'Ram Naam Satya Hai' is maintained. The family remains at the cremation ground until the fire has fully consumed the body — this is an act of devotion and a final act of love.",
        mantra:
    ...
    steps: [
      {
        ...
        details:
          "After the pyre has fully cooled — typically the next morning — the karta and close male relatives return to collect the ashes and bone fragments (asthi / bones). They collect with clean bare hands or copper/brass instruments into a copper or brass vessel. This is done with full reverence, prayer, and mantras. The ash and bone fragments together are called 'Asthi' and are treated as sacred — they are the physical remains of a beloved soul.",
        mantra: "ॐ गतासूनगतासूंश्च नानुशोचन्ति पण्डिताः।",
        mantraTranslit:
          "Om Gatāsūn agatāsūṁś ca nānuśocanti paṇḍitāḥ — The wise grieve neither for the living nor for the dead.",
      },
      {
        step: 2,
        title: "Asthi Visarjan — Immersion of Ashes",
        details:
          "The ashes and bone fragments are immersed in a sacred river — the most sacred act after cremation. The ideal places in order of highest sanctity: (1) Ganga at Varanasi/Kashi — highest liberation, (2) Prayagraj Triveni Sangam, (3) Haridwar Har ki Pauri, (4) Mathura, (5) Vrindavan, (6) Nashik (Godavari), (7) Rameshwaram, (8) Pushkar. Ocean immersion is also deeply sacred. The asthi should be immersed within 3–10 days of death, though some families wait up to one year.",
        mantra: "ॐ त्वं वायुश्च आपश्च ज्योतिश्च पृथिवी च।",
        mantraTranslit:
          "Om tvaṁ vāyuśca āpaśca jyotiśca pṛthivī ca — You are air, water, fire, and earth.",
      },
      {
        step: 3,
        title: "Tarpana at the Sacred River",
        details:
          "After immersing the ashes, the karta stands in the river (or at its bank) and offers three handfuls of water (tarpana) mixed with black sesame seeds and kusha grass. He recites the departed's name, gotra (lineage), and the tarpana mantra. This is offered three times — once for the soul, once for their father's soul, once for their grandfather's soul. This nourishes three generations of ancestors simultaneously.",
        mantra: "ॐ [नाम] [गोत्र] पितृभ्यः स्वधा नमः, तृप्यध्वम्। स्वधा नमः। स्वधा नमः॥",
        mantraTranslit:
          "Om [Name] [Gotra] Pitṛbhyaḥ Svadhā Namaḥ, Tṛpyadhvam. Svadhā Namaḥ. Svadhā Namaḥ.",
      },
      {
        step: 4,
        title: "Return Home — Purification",
        details:
          "Upon returning home after cremation, all family members must bathe immediately and change into clean clothes. The house where the death occurred is sprinkled thoroughly with Gangajal in every room. The main door is washed. No cooking is done by the immediate family on the day of cremation — community members, neighbors, and friends provide food. This community support is one of the most beautiful expressions of dharmic life.",
      },
    ],
  },
];
...
export const SHRADHA_DAYS: ShraddhaDay[] = [
  {
    day: "Day 1",
  ...
  },
  {
    ...
    details:
      "The 11th day is the most important ritual day of the entire 13-day period. The 'Ekodishta Shradh' is performed — a complete shradh dedicated solely and exclusively to the newly departed soul. A complete meal is served to Brahmins. Nagbali and Narayan Bali (special purificatory rituals for untimely death, accidental death, or death without sacred rites) should be performed by a qualified pandit if required. On this day, major donations are made in the name of the deceased — Vastra Daan (clothing), Anna Daan (food), Sayyaa Daan (bed and bedding), Taila Daan (oil/ghee), and any cherished personal items of the deceased. The Vishnu Sahasranama is recited.",
    mantra: "ॐ एकोद्दिष्ट श्राद्धं सम्पन्नं भवतु। पितृ आत्मा तृप्यतां स्वधा॥",
    verse:
      "On this day the soul receives its full spiritual sustenance for the remaining journey — every act of charity done today sends merit directly to the ascending soul.",
  },
  {
    day: "Day 12",
...
export const SACRED_RIVERS: SacredRiverInfo[] = [
  ...
  },
  {
    ...
    significance:
      "Haridwar means 'Gateway to Hari (Vishnu)' — where the Ganga descends from the Himalayas to the plains. Asthi Visarjan at Har ki Pauri Ghat during the evening Ganga Aarti is one of the most spiritually charged acts in Sanatan Dharma. The Ganga at Haridwar carries the highest divine energy from its mountain source. The Kankhal area of Haridwar has a dedicated facility for Asthi Visarjan.",
    bestTime:
      "Ganga Dussehra, Kumbh Mela, Pitru Paksha, and any Amavasya evening.",
    icon: "🏔️",
  },
  {
...
export const SOUL_VERSES: SoulVerse[] = [
  {
    ...
    meaning:
      "Just as the embodied soul continuously passes, in this body, from childhood to youth to old age, similarly the soul passes into another body at death. A sober person is not bewildered by such a change.",
    forFamilyMeaning:
      "Death is simply another passage — like the passing from childhood to adulthood. The soul has made this passage many times. There is nothing to fear in this transition. The grief you feel is love — and that love has no end.",
    krishnaSpeak:
      "The one you love has made this journey before, Arjun. Many times. Each time returning, each time growing. Now they step into the next passage. Be steady. Be loving. Be at peace.",
  },
  {
    ref: "BG 2.19",
    chapter: "Chapter 2 — Sankhya Yoga",
    ...
    meaning:
      "He who thinks the living entity is the slayer, and he who thinks it is slain, are both without knowledge, for the self slays not, nor is it slain.",
    forFamilyMeaning:
      "No one truly dies. No one truly takes life. The soul exists beyond all action, beyond all harm. What appears as death is simply the soul stepping beyond the reach of the body — into a wider, freer existence.",
    krishnaSpeak:
      "Arjun, you did not lose them. The universe did not take them. The soul simply moved beyond the reach of what you could see. They are still. They are complete. They are free.",
  },
  {
    ref: "BG 2.20",
    chapter: "Chapter 2 — Sankhya Yoga",
    ...
    transliteration:
      "Na jāyate mriyate vā kadācin, nāyaṁ bhūtvā bhavitā vā na bhūyaḥ. Ajo nityaḥ śāśvato 'yaṁ purāṇo, na hanyate hanyamāne śarīre.",
    meaning:
      "The soul is never born nor does it die at any time. It has not come into being, does not come into being, and will not come into being. It is unborn, eternal, ever-existing, and primordial. It is not slain when the body is slain.",
    forFamilyMeaning:
      "There is no death. There is no end. The soul that lived in the person you love — that soul is permanent, unslayable, and eternal. It existed before their birth. It exists after their death. It cannot die.",
    krishnaSpeak:
      "Right now, in this moment of grief, I tell you — there is no death. There is only a doorway. The one you love has not gone. They have simply stepped through a doorway into a wider room.",
  },
  {
    ref: "BG 2.22",
    chapter: "Chapter 2 — Sankhya Yoga",
    ...
    forFamilyMeaning:
      "The body that you see is only a garment. The beloved soul that lived within it — that eternal presence — has simply moved forward into a new and freer existence. The garment is set down. The soul walks forward, lighter.",
    krishnaSpeak:
      "The body you see resting is only a garment. The soul that loved you — that soul — has simply moved forward. They are free from the weight of the body. Free from pain. Free from limitation. They are free.",
  },
  {
    ref: "BG 2.23",
    chapter: "Chapter 2 — Sankhya Yoga",
    ...
    transliteration:
      "Naināṁ chindanti śastrāṇi naināṁ dahati pāvakaḥ. Na cainaṁ kledayanty āpo na śoṣayati mārutaḥ.",
    meaning:
      "The soul can never be cut to pieces by any weapon, nor burned by fire, nor moistened by water, nor withered by the wind.",
    forFamilyMeaning:
      "Even as the body is committed to fire in the sacred Antyesti rites — the soul is completely untouched. The fire of the pyre does not hurt the soul. It liberates it. The soul that lived in the body you loved is indestructible.",
    krishnaSpeak:
      "Nothing — not fire, not time, not distance — can ever touch the soul that you love. That soul is indestructible. Your love for them is also indestructible. Love does not die with the body.",
  },
  {
    ref: "BG 2.24",
    chapter: "Chapter 2 — Sankhya Yoga",
    ...
    forFamilyMeaning:
      "The soul is present everywhere — not confined to one place, one body, one form. The one you love is not gone to a distant place. They are present everywhere that love is present. In this room. In your heart.",
    krishnaSpeak:
      "They are not far, Arjun. The soul has no distance. Feel them in the morning light. In the smell of their favourite flower. In the name of Krishna. In the silence between your heartbeats.",
  },
  {
    ref: "BG 2.27",
    chapter: "Chapter 2 — Sankhya Yoga",
    ...
    forFamilyMeaning:
      "Birth and death are as certain as sunrise and sunset. They are the sacred rhythm of existence. Grief is natural, human, and sacred — let it flow. But know that in the great rhythm, all things return. Nothing is truly lost.",
    krishnaSpeak:
      "Grieve, Arjun. Grief is love. But do not drown in it. Your beloved's soul has moved into the great cycle — and in that cycle, all things return. All love is preserved.",
  },
  {
    ref: "BG 4.9",
    ...
    forFamilyMeaning:
      "A soul that lived in devotion to God — a soul that loved Krishna, chanted His name, served His creation — goes to Krishna. Not to suffering. Not to darkness. Not to another painful birth. To Krishna.",
    krishnaSpeak:
      "One who loved Me, who took My name — comes to Me. Not to suffering. Not to darkness. To Me, Arjun. That is where your beloved is going. To Me.",
  },
  {
    ref: "BG 8.5",
    ...
    meaning:
      "Whoever, at the time of death, gives up the body while remembering Me alone, reaches My nature. Of this there is no doubt.",
    forFamilyMeaning:
      "This is why chanting Krishna's name in the ear of the dying is so powerfully important. Those two words — Hare Krishna — are a lantern lighting the path directly to God. If you did this for your loved one, know that it reached them.",
    krishnaSpeak:
      "Speak My name softly into their ear. 'Hare Krishna.' Those two words are a lantern lighting their path home to Me. Even now, even after — keep chanting. The sound travels beyond what you can see.",
  },
  {
    ref: "BG 8.6",
    chapter: "Chapter 8 — Akshara Brahma Yoga",
    ...
    forFamilyMeaning:
      "This is the most important verse for the moment of death. Whatever the dying person is thinking of in their final moment — that is where they go. Fill that moment with Krishna. Fill the room with His name. Fill the air with His presence.",
    krishnaSpeak:
      "Fill their final moments with My name. Their last thought becomes their destination. Give them Me, Arjun. That is the greatest gift you can give anyone.",
  },
  {
    ref: "BG 9.22",
    ...
    forFamilyMeaning:
      "Those who loved and worshipped God — Krishna personally takes care of them. In life and beyond life. Their welfare in their ongoing journey is Krishna's personal responsibility. You can trust this completely.",
    krishnaSpeak:
      "A soul that came to Me — I carried them in life and I carry them beyond. Their welfare is My personal responsibility. I am with them now. Trust Me.",
  },
  {
    ref: "BG 9.31",
    chapter: "Chapter 9 — Raja Vidya Yoga",
    ...
    meaning:
      "He quickly becomes righteous and attains lasting peace. Declare it boldly, O son of Kunti — My devotee never perishes.",
    forFamilyMeaning:
      "Krishna's greatest promise: A devotee — a soul that remembered God — never perishes. Never. Not ever. Not in death, not in the afterlife, not in any journey of the soul. This is Krishna's personal guarantee.",
    krishnaSpeak:
      "My devotee never perishes. Never. I have declared this before all creation. I declare it again to you, right now, in this moment of your grief. Believe Me.",
  },
  {
    ref: "BG 15.6",
    ...
    forFamilyMeaning:
      "There is a place of pure light — beyond this world of birth and death — where the soul that loved God can go. A place so luminous it needs no sun, no moon, no fire. That is Krishna's abode. That is where your beloved may be journeying.",
    krishnaSpeak:
      "My abode needs no sun, no moon, no fire. It is light itself — pure, eternal, joyful light. That is where I am taking them. Do not grieve. Rejoice. They are coming home.",
  },
  {
    ref: "BG 18.65",
    ...
    forFamilyMeaning:
      "'You will come to Me' — this is Krishna's personal, unconditional promise to every soul that loves Him. Not a possibility, not a hope, not a maybe. A promise from God to every devoted soul.",
    krishnaSpeak:
      "You will come to Me. This I promise you. You are My dear friend. And so is every soul that ever remembered Me with love. Your beloved is remembered. They are dear to Me. They will come to Me.",
  },
  {
    ref: "BG 18.66",
    chapter: "Chapter 18 — Moksha Sannyasa Yoga",
    ...
    forFamilyMeaning:
      "The final, ultimate promise of the Gita — surrender to Me, and I will free you from everything. Fear nothing. The soul you love is in God's hands. And you, who grieve for them, are also in God's hands. Do not fear.",
    krishnaSpeak:
      "Do not grieve. Do not fear. I have promised. The soul you love is eternal. They are in My hands. And so are you. Hare Krishna.",
  },
  {
    ref: "BG 6.30",
    ...
    forFamilyMeaning:
      "A soul who saw God everywhere — in the dawn, in others' faces, in acts of kindness — that soul is never lost to Krishna. And Krishna is never lost to them. They are in each other's sight, forever.",
    krishnaSpeak:
      "A soul who saw Me in the world — in kindness, in beauty, in devotion — I see them. I have always seen them. They are not lost from My sight. Not now. Not ever.",
  },
];
