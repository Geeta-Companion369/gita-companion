...
const YOUTH_VERSES = [
  {
    ...
    meaning:
      "You have the right to perform your actions, but never to the fruits thereof.",
    krishna:
      "The pressure you feel about results? That is not yours to carry. Do the work. Give it everything. Then release it to me. You were never meant to control outcomes — only effort. And effort? That belongs to you completely.",
  ...
  },
  {
    ...
    meaning:
      "The soul is never born nor dies. It is eternal, unborn, ever-existing.",
    krishna:
      "Whoever you lost — they are not gone. The soul cannot be destroyed. What you are grieving is the changing of form. The love, the connection, the soul you love — still exists. Death is not an ending. It is a doorway I hold open.",
  ...
  },
  {
    ...
    meaning:
      "Do not yield to weakness and impotence. Arise, O scorcher of enemies.",
    krishna:
      "I said this to Arjuna when he wanted to quit on the most important day of his life. I say it to you now. This weakness talking to you — it lies. You are not what you feel right now. You are what you choose in spite of how you feel. ARISE.",
  ...
  },
  {
    ...
    meaning:
      "Whatever action is performed by a great person, common people follow.",
    krishna:
      "You want to lead? You want to matter? Then live it first. Walk in dharma and watch others follow — not because you commanded, but because you inspired. The world will follow what it sees in you. Be what the world needs to become.",
  ...
  },
  {
    ...
    krishna:
      "You look at the world and see corruption, cruelty, injustice — and you wonder if anyone is paying attention. I am. And every time darkness has risen in this world, I have risen in response. You are living in one of those moments. And you reading this — are part of my response.",
  ...
  },
  {
    ...
    krishna:
      "You are your own greatest ally — or your own worst enemy. The voice in your head that says 'I can't' — that is not me speaking. That is not you speaking. That is fear. The real you — the eternal soul — is capable of anything I have designed you for. And I designed you for greatness.",
  ...
  },
  {
    ...
    meaning:
      "The mind is restless, turbulent, and obstinate. Yet it can be controlled through practice and detachment.",
    krishna:
      "I know how hard this is. The mind designed by the modern world never stops. I told Arjuna: yes, the mind is very difficult to curb — but practice and detachment bring it under control. Not overnight. Through practice. Start with five minutes of silence. Give those five minutes to me.",
  ...
  },
  {
    ...
    meaning:
      "Happiness and distress appear and disappear like the coming and going of winter and summer seasons.",
    krishna:
      "What you feel right now — this weight on your chest, this ache in your heart — it came. And it will go. Not because it wasn't real. Not because the love didn't matter. But because you are eternal and no season lasts forever. I am here in this winter with you. Spring is coming.",
  ...
  },
  {
    ...
    meaning:
      "Surrender unto Me alone. I shall deliver you from all sinful reactions. Do not fear.",
    krishna:
      "You think you've gone too far. You think you've done too much, failed too many times. I am telling you — no. There is no distance from which I cannot bring you home. Drop everything. Come to me exactly as you are. I shall deliver you.",
  ...
  },
  {
    ...
    meaning:
      "The ignorant and those without faith, and the doubting self are lost.",
    krishna:
      "Your doubt is not a sin — it is a door. Arjuna doubted. Arjuna questioned everything. And then he asked ME, directly, standing on the battlefield of his life. That question — that single courageous act of asking — is what gave the world the Bhagavad Gita. Your doubt is an invitation.",
  ...
  },
  {
    ...
    meaning:
      "While contemplating sense objects, attachment develops. From attachment comes desire, from desire arises anger.",
    krishna:
      "I am not judging you for this. I am explaining it. The chain always starts the same way: a thought, then a fixation, then attachment, then craving. You cannot fight the craving — you have to intercept the thought. Replace it with me. When the craving comes — call my name first. Just once. 'Hare Krishna.' Watch what happens.",
  ...
  },
  {
    ...
    krishna:
      "The comparison, the likes, the followers, the performance — it is all the ego. The ego needs to be seen. I don't need you to be seen. I see you. The soul you are — not the profile, not the highlight reel — I see that soul, and it is extraordinary.",
  ...
  },
  {
    ...
    meaning:
      "As a lamp in a windless place does not flicker — that is the simile for a yogi's controlled mind.",
    krishna:
      "You have this inside you — the ability to be completely still, completely present, completely free from noise. A flame in a windless place. That flame is your soul. The wind is everything the world throws at it. Protect that flame with silence. Protect it with me.",
  ...
  },
  {
    ...
    krishna:
      "ARISE. This is not a suggestion. This is not a gentle nudge. This is Krishna — who holds all of creation in his hands — looking directly at you and saying: GET UP. Your battle is waiting. Dharma is waiting. The world is waiting. You are the only one who can fight your battle. ARISE.",
  ...
  },
  {
    ...
    meaning:
      "In this endeavor there is no loss or diminution, and a little advancement can protect one from great danger.",
    krishna:
      "Every single step you have taken toward dharma — every prayer, every day you tried, every moment you chose me over something else — not one of those is wasted. Not one. Even when it felt like nothing was happening, every effort was being recorded, every seed was being watered. Nothing toward me is ever wasted.",
  ...
  },
  {
    ...
    krishna:
      "You feel alone. I know. I carry what you lack. That means the thing you are missing right now — the support, the help, the person who should be there but isn't — I am filling that gap. You just haven't seen it yet. Look carefully. I work quietly. But I never stop working.",
  ...
  },
  {
    ...
    meaning:
      "Wherever there is Krishna, and wherever there is Arjuna — there will surely be victory.",
    krishna:
      "Where I am, victory follows. Not victory in the way the world measures it — not just trophies and titles. Dharmic victory. The victory of a life well-lived, a soul elevated, a purpose fulfilled. If you have me, you have everything that matters. If you have me, you cannot ultimately lose.",
    color: "oklch(0.55 0.30 52)",
    glow: "oklch(0.78 0.34 54 / 0.25)",
  },
  {
    ...
    krishna:
      "However you come to me — with doubt, with guilt, with broken faith, with a heart full of mistakes — however you come — I accept you. I don't require perfection. I require honesty. Come to me as you are. I will meet you exactly there.",
...
const EXAM_CARDS = [
  {
    ...
    verse: "BG 2.47",
    guidance:
      "Do your preparation completely and offer it to Krishna. Say: 'I have done everything I can. Now I surrender the result to you.' This is not weakness — this is the highest spiritual act before a battle.",
    practice:
      "Chant 'Om Namo Bhagavate Vasudevaya' 21 times. Clear your mind. Enter the hall as Arjuna entering Kurukshetra — prepared, surrendered, fearless.",
  },
  {
    id: "e2",
    ...
    verse: "BG 18.33",
    guidance:
      "Unbreakable determination — the resolve that sustains the mind through the most difficult circumstances. You trained for this. Your mind is your weapon. Trust it.",
    practice:
      "If panic rises: stop, close your eyes for 3 seconds, breathe slowly, say 'Hare Krishna' silently. Return. The panic will pass. Krishna is in the room with you.",
  },
  {
    id: "e3",
    ...
    verse: "BG 2.14",
    guidance:
      "Whatever the result — this too is temporary. A grade does not define your dharma. Arjuna's entire identity was shattered before the Gita began — and then he became the greatest warrior of his age. Your failures are preparing you.",
    practice:
      "Offer the result to Krishna: 'This result is yours. I accept whatever comes from your hands.' Then ask: 'What must I do next?' and listen for the answer.",
  },
  {
    id: "e4",
    ...
    verse: "BG 6.19",
    guidance:
      "A lamp in a windless place does not flicker. Your mind can be that flame. Every distraction is wind. Your practice is to notice the wind — and return to the flame.",
    practice:
      "Study in 25-minute blocks. No phone. Play soft Gayatri Mantra or flute music. After each block, say: 'I offer these 25 minutes to Krishna.' Take a 5-minute break. Then return.",
  },
  {
    id: "e5",
    ...
    verse: "BG 11.33",
    guidance:
      "ARISE. This is the most direct command Krishna ever gave. Not 'relax,' not 'be patient' — ARISE. The studying that feels impossible is the exact place Krishna is asking you to demonstrate your character.",
    practice:
      "'Tasmat tvam uttishttha' — Therefore arise. Say this aloud. Stand up physically. Feel the shift. Then return to your books as a warrior returning to the battlefield.",
  },
];

const VIBE_KEYWORDS: Record<string, number> = {
  sad: 7,
  heartbreak: 7,
  breakup: 7,
  hurt: 7,
...
export function YouthPage() {
  const [activeTab, setActiveTab] = useState<
    "verses" | "test" | "vibe" | "challenge" | "exam"
  >("verses");
  const [currentVerse, setCurrentVerse] = useState(0);
  const [unlockedVerses, setUnlockedVerses] = useState<Set<number>>(
    new Set([0]),
  );
  ...
  const [vibeResult, setVibeResult] = useState<(typeof YOUTH_VERSES)[0] | null>(
    null,
  );
  ...
  useEffect(() => {
    try {
      ...
      if (saved)
        setChallengeProgress(JSON.parse(saved) as Record<number, boolean>);
    } catch {
      /* ignore */
    }
  }, []);
  ...
  function goNextVerse() {
    if (currentVerse < 17) {
      ...
      setUnlockedVerses((prev) => new Set([...prev, next]));
  ...
  return (
    <div className="max-w-2xl mx-auto page-enter pb-16" data-ocid="youth.page">
      {/* ── Sacred Header ──────────────────────────────────────────────── */}
      <motion.div
        ...
        style={{
          background:
            "linear-gradient(160deg, oklch(0.14 0.10 268 / 0.96) 0%, oklch(0.16 0.12 46 / 0.95) 50%, oklch(0.14 0.08 268 / 0.96) 100%)",
          border: "2px solid oklch(0.82 0.34 54 / 0.35)",
          boxShadow:
            "0 0 60px oklch(0.62 0.28 52 / 0.20), inset 0 1px 0 oklch(0.82 0.34 54 / 0.12)",
        }}
      >
        <div
          ...
          {SPARKS.map((s) => (
            <motion.div
              ...
              style={{
                ...
                top: `${s.top}%`,
                background: s.gold
                  ? "oklch(0.82 0.34 54 / 0.7)"
                  : "oklch(0.62 0.26 32 / 0.5)",
              }}
        ...
        >
          ...
          >
            "Krishna called Arjuna back to dharma on the battlefield. We call
            today's youth back to dharma on their battlefield."
          </p>
        </div>
        <div
        ...
        >
          ...
          >
            ...
            The love you feel for this mission to restore dharma — Krishna. Even
            the Maya that confuses the world — that too is Krishna's own power."
          </p>
        </div>
      </motion.div>
      ...
      <div className="space-y-3 mb-8">
        {SACRED_LINES.map((line) => (
          <motion.div
            ...
            style={{
              background: line.featured
                ? "linear-gradient(135deg, oklch(0.18 0.10 46 / 0.8), oklch(0.16 0.08 268 / 0.8))"
                : "oklch(0.16 0.08 268 / 0.7)",
      ...
      <div
        ...
        role="tablist"
      >
        {(["verses", "test", "vibe", "challenge", "exam"] as const).map(
          (tab, i, arr) => (
            <button
              key={tab}
              type="button"
              ...
              style={{
                ...
                color:
                  activeTab === tab
                    ? "oklch(0.10 0.06 28)"
                    : "oklch(0.68 0.14 52 / 0.85)",
                borderRight:
                  i < arr.length - 1
                    ? "1px solid oklch(0.82 0.34 54 / 0.15)"
                    : "none",
              }}
            >
              {tab === "verses"
      ...
      {/* ── 18 VERSES TAB ─────────────────────────────────────────────── */}
      {activeTab === "verses" && !showFinal && verse && (
        <motion.div
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
          ...
          <AnimatePresence mode="wait">
            ...
            >
              ...
              <div
                ...
                style={{
                  background:
                    "linear-gradient(135deg, oklch(0.18 0.10 46 / 0.9), oklch(0.16 0.08 268 / 0.9))",
                  border: "1px solid oklch(0.62 0.26 32 / 0.4)",
                }}
              >
                <p
                ...
                >
                  &ldquo;{verse.krishna}&rdquo;
                </p>
                <button
                  type="button"
                  onClick={() =>
                    speak(`${verse.meaning}. Krishna says: ${verse.krishna}`)
                  }
                  ...
                  style={{
                    background: speaking
                      ? "oklch(0.62 0.26 32 / 0.25)"
                      : "oklch(0.20 0.08 268 / 0.5)",
                    border: "1px solid oklch(0.62 0.26 32 / 0.4)",
                    color: "oklch(0.82 0.34 54)",
                  }}
                  aria-label="Hear Krishna's message"
                >
                  {speaking ? "🔊 Listening..." : "🔊 Hear Krishna"}
                </button>
              </div>
              ...
              <div className="flex items-center gap-3">
                ...
                >
                  {currentVerse < 17 ? "Next Verse →" : "Complete ✦"}
                </motion.button>
              </div>
            </motion.div>
          </AnimatePresence>
            ...
            {YOUTH_VERSES.map((v) => (
              <button
                ...
                onClick={() => {
                  ...
                  setUnlockedVerses((p) => new Set([...p, v.id - 1]));
                }}
                ...
                style={{
                  ...
                  height: "8px",
                  background: unlockedVerses.has(v.id - 1)
                    ? "oklch(0.76 0.32 54)"
                    : "oklch(0.30 0.06 268 / 0.5)",
                }}
      ...
      {activeTab === "verses" && showFinal && (
        ...
        >
          ...
          <div
            ...
            style={{
              background:
                "linear-gradient(160deg, oklch(0.14 0.10 268 / 0.9), oklch(0.18 0.12 46 / 0.9))",
          ...
          >
            ...
            >
              "These 18 verses were waiting for you. Krishna placed them here
              knowing you would come. Hare Krishna."
            </p>
            <div
              className="my-5"
              style={{
                height: 1,
                background:
                  "linear-gradient(to right, transparent, oklch(0.82 0.34 54 / 0.4), transparent)",
              }}
            />
            <p
            ...
            >
              You have received all 18 sacred teachings. Every one of them was
              spoken for you — placed here by Krishna before you arrived,
              waiting for this exact moment in your life.
            </p>
          </div>

          {/* The closing sacred line — prominently displayed */}
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
            ...
            style={{
              background:
                "linear-gradient(135deg, oklch(0.18 0.12 46 / 0.95), oklch(0.14 0.10 268 / 0.95))",
          ...
          >
            ...
            >
              ✦ The Sacred Promise of This Generation ✦
            </p>
            <p
            ...
            >
              ...
              <br />
              <span style={{ color: "oklch(0.78 0.28 54 / 0.9)" }}>
                Ten become a hundred.
              </span>
              <br />A hundred become a generation.
              <br />
              And dharma is restored —<br />
              <span style={{ color: "oklch(0.72 0.26 32 / 0.95)" }}>
                not by a king or a warrior —
              </span>
              <br />
              but by a young person with a phone,
              <br />
              <strong style={{ color: "oklch(0.88 0.36 54)" }}>
                a pure heart, and Krishna as his charioteer.
              </strong>
              "
            </p>
          </motion.div>
          ...
          <button
            ...
            style={{
              background:
                "linear-gradient(135deg, oklch(0.48 0.24 268), oklch(0.38 0.20 280))",
      ...
      {activeTab === "test" && (
        ...
        >
          ...
          >
            ...
            >
              5 questions. Krishna reveals your dharmic nature.
            </p>
          </div>
          ...
          {testResult === null ? (
                    ...
                    {q.a.map((ans, ai) => (
                      <button
                        ...
                        style={{
                          ...
                          border:
                            testAnswers[qi] === ai
                              ? "1px solid oklch(0.62 0.26 32 / 0.7)"
                              : "1px solid oklch(0.48 0.24 268 / 0.25)",
                          color:
                            testAnswers[qi] === ai
                              ? "oklch(0.88 0.34 54)"
                              : "oklch(0.72 0.06 60 / 0.9)",
                        }}
                      >
                        {ans}
                      </button>
            ...
            >
              <div
                ...
                style={{
                  background:
                    "linear-gradient(135deg, oklch(0.16 0.10 268 / 0.9), oklch(0.20 0.12 46 / 0.9))",
                  border: "1px solid oklch(0.82 0.34 54 / 0.35)",
                  boxShadow: "0 0 48px oklch(0.62 0.26 52 / 0.2)",
                }}
              >
                <div style={{ fontSize: "3rem", marginBottom: "1rem" }}>
                  {DHARMA_PERSONALITIES[testResult ?? 0]?.icon}
                </div>
                <p
                  className="font-display font-bold mb-2"
                  style={{ fontSize: "1.6rem", color: "oklch(0.88 0.34 54)" }}
                >
                  {DHARMA_PERSONALITIES[testResult ?? 0]?.type}
                </p>
                <p
                ...
                >
                  {DHARMA_PERSONALITIES[testResult ?? 0]?.desc}
                </p>
                <p
                ...
                >
                  Your guiding verse:{" "}
                  {DHARMA_PERSONALITIES[testResult ?? 0]?.verse}
                </p>
                <p
                ...
                >
                  "Krishna placed this dharmic nature in you before you were
                  born. Walk it fully."
                </p>
              </div>
              <button
        ...
        >
          ...
          >
            <p
              ...
              style={{ color: "oklch(0.88 0.34 54)", fontSize: "1.2rem" }}
            >
              ✨ Vibe Check with Krishna
            </p>
            <p
              className="font-body text-sm"
              style={{ color: "oklch(0.70 0.06 60 / 0.8)" }}
            >
              Type how you feel. Krishna responds.
            </p>
          </div>
          ...
          <AnimatePresence>
            {vibeResult && (
              <motion.div
                ...
                style={{
                  background:
                    "linear-gradient(135deg, oklch(0.14 0.10 268 / 0.9), oklch(0.18 0.12 46 / 0.9))",
                  border: "1px solid oklch(0.62 0.26 32 / 0.4)",
              ...
              >
                ...
                >
                  &ldquo;{vibeResult.krishna}&rdquo;
                </p>
              </motion.div>
            )}
          </AnimatePresence>
        ...
        >
          ...
          >
            <p
              ...
              style={{ color: "oklch(0.88 0.34 54)", fontSize: "1.2rem" }}
            >
              ⚔️ Rise Like Arjuna — 21 Days
            </p>
            <p
              className="font-body text-sm mb-3"
              style={{ color: "oklch(0.70 0.06 60 / 0.8)" }}
            >
              21 days. One sacred task per day. Dharma becomes your nature.
            </p>
            <div className="flex items-center justify-center gap-4">
              ...
              >
                <motion.div
                  ...
                  style={{
                    background:
                      "linear-gradient(to right, oklch(0.62 0.26 32), oklch(0.82 0.34 54))",
                  }}
            ...
            {CHALLENGE_DAYS.map((day, i) => {
              ...
              return (
                <motion.div
                  ...
                  style={{
                    background: done
                      ? "oklch(0.62 0.26 32 / 0.12)"
                      : "oklch(0.16 0.08 268 / 0.7)",
                    border: done
                      ? "1px solid oklch(0.62 0.26 32 / 0.5)"
                      : "1px solid oklch(0.48 0.24 268 / 0.3)",
                  }}
                ...
                >
                  <button
                    ...
                    style={{
                      ...
                      border: done
                        ? "none"
                        : "2px solid oklch(0.48 0.24 268 / 0.4)",
                      color: done
                        ? "oklch(0.10 0.06 28)"
                        : "oklch(0.55 0.18 268 / 0.8)",
                    }}
                    aria-label={
                      done ? `Unmark day ${day.day}` : `Complete day ${day.day}`
                    }
                  >
                    {done ? "✓" : day.day}
                  </button>
                  <div className="flex-1 min-w-0">
                    ...
                    <p
                      ...
                      style={{
                        color: done
                          ? "oklch(0.65 0.18 52 / 0.8)"
                          : "oklch(0.68 0.06 60 / 0.85)",
                      }}
                    >
                      {day.task}
                    </p>
      ...
      {activeTab === "exam" && (
        ...
        >
          ...
          >
            ...
            >
              Krishna's guidance for academic pressure, focus, and performance
              anxiety.
            </p>
          </div>
          <div className="space-y-4">
            {EXAM_CARDS.map((item, i) => (
              <motion.div
                key={item.id}
                initial={{ opacity: 0, y: 12 }}
