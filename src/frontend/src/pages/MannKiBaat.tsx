...
// 18 role-based affiliations (not emotion-based)
const AFFILIATIONS = [
  {
    id: "student",
    icon: "📚",
    ...
    verse:
      "BG 4.38 — In this world there is nothing so purifying as knowledge. One who has become accomplished in yoga will enjoy this knowledge within himself in due time.",
    guidance:
      "Krishna was the greatest teacher who ever lived. He gave the entire Bhagavad Gita to a confused student facing the greatest exam of his life — and Arjuna passed. Your studies are not separate from your dharma. Every lesson learned is a step toward your svadharma. Ask yourself: what did I truly learn today?",
    practices: [
    ...
    verse2:
      "BG 3.35 — Better is one's own dharma, though imperfectly performed, than the dharma of another well performed. It is better to die in one's own dharma.",
  },
  {
    id: "parent",
    icon: "👨‍👩‍👧",
    ...
    verse:
      "BG 9.22 — For those who worship Me with devotion, meditating on My form, I carry what they lack and I preserve what they have.",
    guidance:
      "Every parent is a Devaki — you brought a soul of Krishna into the world. Your duty is not to own your child's destiny but to prepare the soil. Teach dharma through your own example. The best inheritance is not money — it is character, faith, and the name of Krishna.",
    practices: [
  ...
  },
  {
    ...
    verse:
      "BG 12.13–14 — One who is not envious but is a kind friend to all living entities, who does not think himself a proprietor, who is free from false ego, equal in both happiness and distress, always satisfied, self-controlled, engaged in devotional service with determination.",
    guidance:
      "A sacred marriage is a dharmic partnership — two souls walking the same path toward Krishna. The Saptapadi wedding vows ask you to be eternal friends, not temporary companions. When the marriage feels difficult, ask: Am I fulfilling my vow of friendship? Am I walking toward dharma together?",
    practices: [
    ...
    verse2:
      "BG 13.9 — Non-attachment, absence of clinging to sons, wives, home; constant equal-mindedness in desired and undesired events.",
  },
  {
    id: "child",
    icon: "🌱",
    ...
    verse:
      "BG 2.3 — Do not yield to unmanliness, O Partha. It does not become you. Shake off your faint-heartedness and arise, O conqueror of foes.",
    guidance:
      "Arjuna was young when Krishna spoke the Gita. This entire scripture was given to a young person in crisis. You are not too young to know God. In fact, the younger you begin, the freer your whole life becomes. Your generation will restore dharma — that is why you are here.",
    practices: [
    ...
    verse2:
      "BG 18.66 — Abandon all varieties of dharma and simply surrender unto Me. I shall deliver you from all sinful reactions. Do not fear.",
  },
  {
    id: "entrepreneur",
    icon: "🚀",
    ...
    verse:
      "BG 2.47 — You have a right to perform your prescribed duties, but you are not entitled to the fruits of your action. Never consider yourself the cause of the results of your activities.",
    guidance:
      "The Gita is the greatest business philosophy ever written. Act fully. Strategize like Arjuna. Execute like a warrior. But surrender the result to Krishna completely. The greatest entrepreneurs in dharma built without attachment to outcome — they built because it was their svadharma.",
    practices: [
    ...
    verse2:
      "BG 3.19 — Therefore, always perform your duty efficiently and without attachment to the results, because by doing work without attachment one attains the Absolute.",
  },
  {
    id: "employee",
    icon: "💼",
    ...
    verse:
      "BG 3.9 — Work done as a sacrifice for Vishnu has to be performed; otherwise work causes bondage in this material world. Therefore, O son of Kunti, perform your prescribed duties for His satisfaction.",
    guidance:
      "Every workplace is a Kurukshetra. You will meet Duryodhanas and Dronas. The key is nishkama karma — give your best work without attachment to appreciation or reward. The work itself is your offering. Krishna sees everything.",
    practices: [
    ...
    verse2:
      "BG 18.46 — By performing his own work, one worships the Creator who dwells in every creature. Such worship brings that person to fulfillment.",
  },
  {
    id: "elderly",
    icon: "🕯️",
    ...
    verse:
      "BG 8.5 — Anyone who, at the end of life, quits his body remembering Me alone at once attains My nature. Of this there is no doubt.",
    guidance:
      "Krishna says the final thought determines the next destination. Prepare your mind now — not in fear, but in love. The Antim Yaatra section guides you through this sacred passage. Your years of experience are a treasure. Teach what you know. Share your stories. Dharma is restored one generation at a time.",
    practices: [
    ...
    verse2:
      "BG 2.20 — The soul is never born nor dies at any time. It has not come into being, does not come into being, and will not come into being. It is unborn, eternal, ever-existing, and primeval.",
  },
  {
    id: "grieving",
    icon: "💧",
    ...
    verse:
      "BG 2.20 — The soul is never born nor dies. It has not come into being, does not come into being, and will not come into being. It is unborn, eternal, ever-existing, and primeval.",
    guidance:
      "Your loved one is not gone — they have changed form. The Gita's deepest teaching is that the soul is eternal. Grieve — it is dharmic to grieve. But know this truth: what you loved never truly dies. Only the body returns to the five elements. The soul moves onward in Krishna's plan.",
    practices: [
  ...
  },
  {
    ...
    verse:
      "BG 6.5 — Let a man lift himself by his own self alone, and not let himself down; for the self alone is the friend of the self, and the self alone is the enemy of the self.",
    guidance:
      "Anxiety is the mind living in the future. Krishna's entire teaching is to return to the present action. Right now, in this moment, you are safe. Breathe. Chant one mantra. The mind given a mantra has something sacred to hold. You cannot be anxious and chanting at the same time.",
    practices: [
    ...
    verse2:
      "BG 2.66 — There is no wisdom for the unsteady, and no meditation for the unsteady man. Without meditation there is no peace; without peace how can there be happiness?",
  },
  {
    id: "depressed",
    icon: "🌑",
    ...
    verse:
      "BG 2.14 — Contact of senses with objects gives rise to cold and heat, pleasure and pain. They come and go; they are impermanent. Endure them, O Bharata.",
    guidance:
      "Arjuna too sat paralysed with grief at Kurukshetra. Krishna did not dismiss his pain — He sat beside him and spoke. Your darkness is not a weakness. It is the battlefield where your transformation begins. One step today: open the Gita to Chapter 2. Read just one verse.",
    practices: [
    ...
    verse2:
      "BG 18.66 — Abandon all forms of dharma and simply surrender unto Me. I shall deliver you from all sinful reactions. Do not fear.",
  },
  {
    id: "seeker",
    icon: "🔍",
    ...
    guidance:
      "Even Arjuna doubted. Doubt is the doorway to inquiry — and inquiry leads to knowledge. The seeker is the most beloved of God because they are not satisfied with surfaces. Krishna says: 'Come to me. Leave all other dharmas. I will make it clear.' The Library in this app holds 37 sacred texts — begin anywhere.",
    practices: [
    ...
    verse2:
      "BG 9.2 — This knowledge is the king of education, the most secret of all secrets. It is the purest knowledge, and because it gives direct perception of the self by realization, it is the perfection of religion.",
  },
  {
    id: "devotee",
    icon: "🙏",
    ...
    verse:
      "BG 12.8 — Fix your mind on Me alone. You will then live in Me always — of this there is no doubt. I am easily attained by the person who always remembers Me.",
    guidance:
      "Bhakti is not ritual — it is relationship. Krishna wants your love, not your performance. Talk to him like Meera did. Argue with him like Arjuna did. Surrender like Draupadi did when she called 'Govinda!' in her darkest moment. He always comes. He is here right now.",
    practices: [
  ...
  },
  {
    ...
    verse:
      "BG 11.33 — Arise! Attain glory. Conquer your enemies and enjoy a flourishing kingdom. They have already been arranged to die by Me. You will simply be the instrument, O skilled archer.",
    guidance:
      "You are standing on your own Kurukshetra. Every great soul faced this moment — the moment when everything they loved seemed to be on the other side of what dharma demanded. Arjuna had to fight his own family. And he won because Krishna was in his chariot. Krishna is in yours too.",
    practices: [
  ...
  },
  {
    ...
    verse:
      "BG 3.21 — Whatever action a great man performs, common men follow in his footsteps. And whatever standards he sets by exemplary acts, all the world pursues.",
    guidance:
      "In the Gita, Krishna describes the ideal king and leader — one whose leadership creates wellbeing, not dependency. Who lifts people toward their own dharma, not toward the leader's ego. The world is desperate for dharmic leaders. You are being prepared. Lead by example, not by decree.",
    practices: [
  ...
  },
  {
    ...
    verse:
      "BG 14.20 — The embodied being, having crossed over these three modes, is freed from birth, death, old age and their distresses and enjoys nectar even in this life.",
    guidance:
      "The Dhanvantari — the divine physician — is an avatar of Vishnu. Healing is not a profession, it is a form of seva. Every healer carries others' pain. Remember to give it to Krishna. Your capacity to heal comes directly from Brahman — you are the instrument, He is the source.",
    practices: [
  ...
  },
  {
    ...
    verse:
      "BG 10.41 — Whatever is magnificent, prosperous, or powerful — know that to be a manifestation of a fragment of My splendour.",
    guidance:
      "Krishna is the supreme artist. He created the entire universe as his leela — divine play. Every time you create something beautiful, true, or good — you participate in that leela. Art made as offering becomes sacred. Write, paint, sing, build, dance — not to be seen, but to say: 'This is my offering, Krishna.'",
    practices: [
    ...
    verse2:
      "BG 18.37 — That which is like poison at first but in the end is like nectar and which awakens one to self-realization is said to be happiness in the mode of goodness.",
  },
  {
    id: "server",
    icon: "🤲",
    ...
    verse:
      "BG 18.46 — By performing his own work, one worships the Creator who dwells in every creature. Such worship brings that person to fulfillment.",
    guidance:
      "The greatest yoga is seva. When you serve a human being without expecting anything back, you are serving Krishna in that form. The Gita says God dwells in every creature. Every meal cooked with love for someone else is prasad. Every hand held in grief is darshan. You are touching God.",
    practices: [
  ...
  },
  {
    ...
    verse:
      "BG 10.10 — To those who are constantly devoted to serving Me with love, I give the understanding by which they can come to Me.",
    guidance:
      "The entire Bhagavad Gita was given in a moment of confusion. Arjuna could not see clearly. Krishna did not solve the problem for him — He illuminated the principle. When confused, return to the eternal question: What does my dharma demand of me here? Not what is convenient. What is right.",
    practices: [
    ...
    verse2:
      "BG 4.42 — Therefore, with the sword of knowledge, cut asunder the doubt born of ignorance residing in your heart. Take refuge in yoga. Arise, O Bharata.",
  },
];

export function MannKiBaatPage() {
  ...
  return (
    <div className="max-w-3xl mx-auto pb-28" data-ocid="mann-ki-baat.page">
      {/* Hero Header */}
      <motion.div
      ...
      >
        ...
        >
          Krishna's guidance for 18 sacred life roles — select yours
        </p>
        <p
          className="font-body text-[10px] italic mt-2"
          style={{ color: "oklch(0.62 0.22 52 / 0.75)" }}
        >
          "तस्मात्त्वमुत्तिष्ठ यशो लभस्व" — Therefore, arise and win glory — BG 11.33
        </p>

        {/* Interlinked connections banner */}
        <div
        ...
        {affiliation && (
          ...
          >
            <div
              ...
              style={{
                background:
                  "linear-gradient(160deg, oklch(0.18 0.08 46 / 0.96) 0%, oklch(0.14 0.06 38 / 0.96) 100%)",
              ...
              <div className="p-5">
                <div className="flex items-start gap-3 mb-4">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    >
                      {affiliation.titleHindi} · {affiliation.subtitle}
                    </p>
                  </div>
                  <button
                    type="button"
          ...
          return (
            <motion.button
              ...
              style={{
                background:
                  selected === idx
                    ? `linear-gradient(135deg, ${item.color}55 0%, ${item.color}33 100%)`
                    : "rgba(8,5,22,0.70)",
                border:
                  selected === idx
                    ? `1.5px solid ${item.color}66`
                    : "1.5px solid oklch(0.72 0.28 52 / 0.35)",
                boxShadow:
                  selected === idx ? `0 4px 14px ${item.color}33` : "none",
                minHeight: "88px",
              }}
            >
      ...
      >
        ✦ "The charioteer does not win the battle. Arjuna wins the battle.
