...
const DAILY_VERSES = [
  {
    ...
    translation:
      "You have a right to perform your duties, but never to the fruits of action. Never be motivated by the results, nor become attached to inaction.",
    ref: "BG 2.47",
  },
  {
    chapter: 9,
  ...
  },
  {
    ...
    translation:
      "Whenever and wherever there is a decline in dharma and a rise of adharma — at that time I manifest Myself.",
    ref: "BG 4.7",
  },
  {
    chapter: 6,
  ...
  },
  {
    ...
    translation:
      "Therefore arise and attain glory. Conquer your enemies and enjoy a flourishing kingdom. They are already put to death by My arrangement — you be just the instrument.",
    ref: "BG 11.33",
  },
];
...
const DAY_BLESSINGS: Record<
  number,
  { deity: string; color: string; blessing: string; fast: string }
> = {
  0: {
    deity: "सूर्य देव",
  ...
  1: {
    ...
    blessing:
      "Chant Om Namah Shivaya 108 times. Abhishek with milk is auspicious.",
    fast: "Somvar Vrat",
  },
  2: {
    deity: "हनुमान जी",
  ...
  3: {
    ...
    blessing:
      "Begin new work today with Ganesh puja. Green colour is auspicious.",
  ...
  4: {
    ...
    blessing:
      "Honour your Guru. Yellow colour, banana offering. Most auspicious for learning.",
  ...
  5: {
    ...
    blessing:
      "Perform Lakshmi puja in the evening. White flowers. Excellent for prosperity.",
    fast: "Shukravar Vrat",
  },
  6: {
    deity: "शनि देव",
    ...
    blessing:
      "Offer mustard oil to Shani dev. Black sesame. Feed crows for ancestral peace.",
    fast: "Shanivar Vrat",
  },
};
...
function SplashScreen({ onDone }: { onDone: () => void }) {
  return (
    <motion.div
      ...
      style={{
        background:
          "linear-gradient(180deg, oklch(0.32 0.14 268) 0%, oklch(0.42 0.18 32) 35%, oklch(0.52 0.22 36) 60%, oklch(0.38 0.16 268) 100%)",
      }}
    ...
    >
      <div
        ...
        style={{
          background:
            "radial-gradient(ellipse at 50% 30%, oklch(0.82 0.38 54 / 0.65) 0%, oklch(0.62 0.28 32 / 0.45) 35%, transparent 70%)",
        }}
      />
      <div
        className="absolute inset-0"
        style={{
          background:
            "radial-gradient(ellipse at 50% 75%, oklch(0.46 0.18 32 / 0.7) 0%, transparent 60%)",
        }}
      />
      <div
        ...
        style={{
          height: "35%",
          background:
            "linear-gradient(0deg, oklch(0.36 0.16 32 / 0.95) 0%, oklch(0.50 0.20 36 / 0.6) 50%, transparent 100%)",
        }}
      />
      {[0, 30, 60, 90, 120, 150, 180, 210, 240, 270, 300, 330].map((angle) => (
        <motion.div
          ...
          style={{
            ...
            height: 2,
            background:
              "linear-gradient(90deg, oklch(0.88 0.38 54 / 0.7), transparent)",
      ...
      >
        <div className="flex justify-between px-6 mb-[-8px]">
          {[0, 1].map((i) => (
            <div
              key={i}
              style={{
                ...
                background:
                  "linear-gradient(135deg, oklch(0.58 0.22 46) 0%, oklch(0.44 0.18 36) 100%)",
                display: "flex",
                alignItems: "center",
        ...
        <div
          style={{
            ...
            background:
              "linear-gradient(180deg, oklch(0.62 0.24 46) 0%, oklch(0.50 0.20 36) 100%)",
            ...
            <div style={{ textAlign: "center" }}>
              <div
                style={{
                  ...
                  background:
                    "linear-gradient(180deg, oklch(0.62 0.28 268) 0%, oklch(0.50 0.22 268) 100%)",
                  margin: "0 auto",
                }}
              />
              <div
            ...
            <div style={{ textAlign: "center" }}>
              <div
                style={{
                  ...
                  borderRadius: "6px 6px 0 0",
                  background:
                    "linear-gradient(180deg, oklch(0.72 0.30 32) 0%, oklch(0.60 0.24 32) 100%)",
                  margin: "0 auto",
                }}
              />
              <div
        ...
        <div className="flex justify-center gap-3 mt-0">
          {["horse-a", "horse-b", "horse-c", "horse-d"].map((horseId) => (
            <div
              key={horseId}
              style={{
                width: 14,
                height: 32,
                background:
                  "linear-gradient(180deg, oklch(0.94 0.04 70) 0%, oklch(0.80 0.06 68) 100%)",
...
function DailyVerseCarousel() {
  ...
  function speakVerse() {
    ...
    const utt = new SpeechSynthesisUtterance(verse?.translation ?? "");
    utt.rate = 0.85;
    utt.pitch = 0.9;
  ...
  return (
    <div
      ...
      style={{
        background:
          "linear-gradient(160deg, oklch(0.96 0.08 68 / 0.97) 0%, oklch(0.93 0.10 62 / 0.96) 100%)",
        backdropFilter: "blur(14px)",
        WebkitBackdropFilter: "blur(14px)",
        border: "2px solid oklch(0.74 0.30 52 / 0.55)",
        borderRadius: "10px",
        boxShadow:
          "0 8px 40px rgba(180,130,45,0.28), inset 0 1px 0 rgba(255,248,220,0.80)",
        padding: "1.5rem",
      }}
    >
      <div
        ...
        style={{
          background:
            "linear-gradient(90deg, oklch(0.82 0.36 54), oklch(0.70 0.28 46), oklch(0.58 0.26 268), oklch(0.70 0.28 46), oklch(0.82 0.36 54))",
        }}
      />
      <div className="flex items-center justify-between mb-3">
        ...
        >
          {verse?.ref} — Chapter {verse?.chapter}, Verse {verse?.verse}
        </span>
        <button
          type="button"
          onClick={speakVerse}
          ...
          style={{
            background: playing
              ? "oklch(0.76 0.28 52 / 0.25)"
              : "oklch(0.80 0.28 52 / 0.15)",
        ...
        {DAILY_VERSES.map((v, i) => (
          <button
            ...
            style={{
              ...
              background:
                i === idx ? "oklch(0.78 0.32 46)" : "oklch(0.60 0.16 50 / 0.4)",
            }}
          />
        ))}
      </div>
    ...
    <Link to="/calendar" data-ocid="home.todays-blessing.link">
      <div
        ...
        style={{
          ...
          boxShadow:
            "0 6px 32px rgba(100,80,200,0.18), inset 0 1px 0 rgba(200,200,255,0.22)",
        }}
      >
        <div
      ...
      {open && (
        ...
        >
          <motion.div
            ...
            style={{
              background: isKurukshetra
                ? "linear-gradient(160deg, oklch(0.44 0.16 268) 0%, oklch(0.50 0.18 32) 100%)"
                : "linear-gradient(160deg, oklch(0.50 0.18 18) 0%, oklch(0.44 0.16 268) 100%)",
          ...
          >
            <div
              ...
              style={{
                background: isKurukshetra
                  ? "linear-gradient(90deg, oklch(0.78 0.32 54), oklch(0.68 0.26 46), oklch(0.78 0.32 54))"
                  : "linear-gradient(90deg, oklch(0.72 0.28 18), oklch(0.62 0.24 22), oklch(0.72 0.28 18))",
              }}
            />
            <div className="text-5xl mb-4">{isKurukshetra ? "⚔️" : "🛡️"}</div>
            <p
              className="font-body text-xs tracking-[0.3em] uppercase mb-3"
              style={{ color: "oklch(0.62 0.24 32 / 0.8)" }}
            >
              {isKurukshetra ? "॥ मेरा कुरुक्षेत्र ॥" : "॥ धर्म आपातकाल ॥"}
            </p>
            <p
            ...
            >
              {isKurukshetra
                ...
                : '"Krishna is with you. Whatever battle you face — you are not alone."'}
            </p>
            {isKurukshetra && battlesWon > 0 && (
              <p
                className="font-body text-xs italic mb-3"
                style={{ color: "oklch(0.94 0.12 56 / 0.90)" }}
              >
                🏆 Battles Won: {battlesWon} — Your Kurukshetra continues
              </p>
            )}
            <p
            ...
            >
              {isKurukshetra
                ? "Bring your life's battle to Krishna. He has been waiting. You never face anything alone."
                : "18 life-saving verses. Helplines. Krishna's voice. All offline. I have set aside my flute. Right now, only you matter."}
            </p>
            <button
              type="button"
              onClick={proceed}
              ...
              style={{
                background: isKurukshetra
                  ...
                  : "linear-gradient(135deg, oklch(0.52 0.22 18), oklch(0.68 0.28 32))",
...
export function HomePage() {
  ...
  const [showSplash, setShowSplash] = useState(() => {
    try {
      ...
      if (!last) return true;
      return Date.now() - Number(last) > 3 * 60 * 60 * 1000;
    } catch {
      return true;
    }
  });
  ...
  const [battlesWon] = useState(() => {
    try {
      const raw = localStorage.getItem("kurukshetra-battles");
      if (!raw) return 0;
      const battles = JSON.parse(raw) as Array<{ status: string }>;
  ...
  return (
    <div className="max-w-3xl mx-auto relative">
      ...
      <LotusParticles zIndex={1} opacity={0.4} />

      {/* ═══ HOME CONTENT: OM + Verse of Day + Sacred Blessing ═══ */}
      <motion.div
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
        transition={{ duration: 1.0 }}
      >
        {/* OM Symbol — vibrant, traditional, sacred glow, NO circle, NO rotation */}
        <div className="text-center mb-6 mt-2" data-ocid="home.om-symbol">
          ...
          >
            {/* Hare Krishna — large golden display */}
            <motion.p
              animate={{
                textShadow: [
            ...
            >
              ❦ Hare Krishna · हरे कृष्ण · Hare Rama ❦
            </p>
            {(streak.count > 0 || points.total > 0) && (
        ...
        >
          <div className="flex items-center gap-3 mb-3">
            <div
              ...
              style={{
                background:
                  "linear-gradient(to right, transparent, oklch(0.75 0.32 52 / 0.60))",
              }}
            />
            <h2
            ...
            <div
              ...
              style={{
                background:
                  "linear-gradient(to left, transparent, oklch(0.75 0.32 52 / 0.60))",
              }}
            />
          </div>
          <DailyVerseCarousel />
        ...
        >
          <div className="flex items-center gap-3 mb-3">
            <div
              ...
              style={{
                background:
                  "linear-gradient(to right, transparent, oklch(0.66 0.26 268 / 0.55))",
              }}
            />
            <h2
              className="font-display text-xs font-bold italic tracking-[0.18em] uppercase whitespace-nowrap"
            ...
            <div
              ...
              style={{
                background:
                  "linear-gradient(to left, transparent, oklch(0.66 0.26 268 / 0.55))",
              }}
            />
          </div>
          <TodaysBlessingCard />
      ...
      {/* ─── Bottom Verse Ticker — slow 75s scroll ─────────────────────────────── */}
      <style>{`
      ...
      <div
        ...
        style={{
          ...
          background:
            "linear-gradient(90deg, oklch(0.90 0.14 56 / 0.97), oklch(0.88 0.16 52 / 0.97))",
          backdropFilter: "blur(8px)",
          paddingTop: "5px",
          paddingBottom: "5px",
        }}
