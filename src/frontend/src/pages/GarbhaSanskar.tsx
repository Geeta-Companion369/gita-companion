      ...
      {petals.map((p) => (
        <motion.div
          ...
          initial={{
            opacity: 0,
            y: -24,
            x: `${p.left}vw` as unknown as number,
            rotate: 0,
          }}
          animate={{
  ...
  return (
    <div className="flex items-center gap-3 my-5" aria-hidden>
      <div
        ...
        style={{
          background:
            "linear-gradient(90deg, transparent, #F4A7B9, transparent)",
        }}
      />
      <span
        style={{
...
const JOURNEY_MONTHS = [
  {
    ...
    ayurveda:
      "This is Garbhadhana — the sacred conception ceremony. Light a diya of pure ghee before sleep. Consume warm milk with saffron and ashwagandha to prepare the body as a divine vessel.",
    modern:
      "Week 1–2: Fertilisation and implantation. Week 3–4: The neural tube that forms the brain and spinal cord is already developing.",
    mantraGuidance:
      "Chant 'Om Namo Narayanaya' 108 times every morning. The vibration enters the body at a cellular level. The soul choosing this womb can hear the welcome prayer.",
    gitaVerse:
      'BG 10.20 — "I am the Self seated in the heart of all beings. I am the beginning, the middle and the end of all creatures." The soul entering is divine — greet it with this awareness.',
    story:
      "In the Puranas, before Prahlad was conceived, his mother performed sacred chanting for 40 days. Prahlad was born already knowing the name of Vishnu. Your intention shapes the soul before conception.",
    weekGuide: [
  ...
  },
  {
    ...
    ayurveda:
      "Take saffron-milk daily (a pinch of saffron in warm cow's milk). According to Charaka Samhita, saffron in the second month promotes a calm temperament and divine complexion in the child.",
    modern:
      "Week 5–6: Baby's heart begins beating at around 21 days from conception. Week 7–8: Eyes, ears, and tiny limb buds are forming. The embryo is now 12mm long — the size of a raspberry.",
    mantraGuidance:
      "Recite the Mahamantra 108 times daily, placing your hands gently over your heart. The sound of Krishna's name is not ordinary — it is the highest vibration in creation. What the baby absorbs now becomes their permanent nature.",
    gitaVerse:
      'BG 9.22 — "To those who worship Me with devotion, meditating on My transcendental form, I carry what they lack and preserve what they have." You are already protected.',
    story:
      "When Subhadra was pregnant with Abhimanyu, she would listen to Arjuna describe complex battle formations. Abhimanyu absorbed the Chakravyuh formation while still in the womb. Every word a mother hears is the child's first education.",
    weekGuide: [
  ...
  },
  {
    ...
    ayurveda:
      "Increase ghee intake — one tablespoon of pure cow ghee in warm milk each morning. Ayurveda states ghee in Month 3 develops intelligence and emotional stability in the child.",
    modern:
      "Week 9–10: All vital organs are forming. Week 11–12: The baby is now called a fetus. Fingers are visible. The baby can make small movements though you cannot feel them yet.",
    mantraGuidance:
      "Speak to the baby every single morning. Tell them about Krishna — about Vrindavan, about the flute, about the divine childhood. Your voice is their entire universe right now.",
    gitaVerse:
      'BG 7.9 — "I am the pure fragrance of the earth and the brightness in fire." Tell your baby: the fragrance of flowers, the warmth of the sun — these are all Krishna reaching out to you.',
    story:
      "Ancient texts describe how Valmiki composed the Ramayana while a pregnant woman sat in his ashram listening. Her son Lava was born already knowing the verses by heart. The mother's learning IS the child's inheritance.",
    weekGuide: [
  ...
  },
  {
    ...
    ayurveda:
      "Begin playing classical ragas. Raga Bhairav at dawn removes obstacles. Raga Yaman in evening promotes creativity and emotional depth. Charaka prescribes specific ragas for each trimester.",
    modern:
      "Week 14–15: Baby's ears are fully formed and hearing begins. Week 16–17: Baby can now hear your voice clearly and may turn toward familiar sounds. This is the most critical window for sound programming.",
    mantraGuidance:
      "Play Vishnu Sahasranama continuously in the background during the day. Recite Ganesha mantra 21 times each morning — the Vighnaharta removes all obstacles from this sacred journey.",
    gitaVerse:
      'BG 13.14 — "Everywhere are His hands and legs, His eyes, heads and faces and He has ears everywhere. In this way the Supersoul exists, pervading everything." The divine hears what you chant to your baby.',
    story:
      "Krishna's own birth was preceded by prophecies, prayers, and sacred chanting by Devaki. Even in prison, she sang to him. He emerged knowing his divine mission. Sound carries the seeds of destiny.",
    weekGuide: [
  ...
  },
  {
    ...
    ayurveda:
      "In Month 5, Ayurveda prescribes Punsavana Samskara performed by a learned priest. Consume barleycorn mixed with honey. Avoid all tamasic environments — loud, violent, or distressing spaces harm the child's psyche.",
    modern:
      "Week 18–20: Baby's movements can now be felt for the first time (quickening). Week 21–22: The baby is about 27cm long. A sleep-wake cycle is established. Baby reacts to sounds with movement.",
    mantraGuidance:
      "Perform Punsavana with your family — light 108 diyas, offer flowers, chant Lakshmi mantra. Write your Sankalpa — the sacred promise you make to this soul. This ceremony programs the baby's subconscious with divine energy.",
    gitaVerse:
      'BG 3.11 — "By your sacrifice the devas will be pleased and by co-operation between men and devas, prosperity will reign for all." Your devotion and the divine\'s grace work together in this ceremony.',
    story:
      "In Dvapara Yuga, Punsavana was performed on the third or fourth month and involved the whole village. Every well-wisher's prayers added to the child's spiritual protection. Even today, collective love creates a shield around the unborn soul.",
    weekGuide: [
  ...
  },
  {
    ...
    ayurveda:
      "Maximum sattvic diet now: organic cow's milk twice daily, pure ghee with every meal, fresh fruits only, soaked almonds each morning (promotes brain development), no processed food. Charaka: the 6th month governs the baby's emotional temperament.",
    modern:
      "Week 23–24: Baby's brain is rapidly developing. Week 25–26: Baby opens eyes for the first time. Week 27: Baby can now dream. The patterns of sleep and emotional mood are being set permanently this month.",
    mantraGuidance:
      "Shiva mantra grounds the energy — it provides stability, dissolves fear, and creates stillness. Chant especially when anxious. Place your hands over your heart and feel stillness as you chant.",
    gitaVerse:
      'BG 17.8 — "Foods that are juicy, fatty, wholesome, and pleasing to the heart are dear to those in the mode of goodness." Eat only what you would offer to Krishna first.',
    story:
      "Kunti fasted and prayed before each pregnancy, eating only fruit and sattvic food. Each son emerged with the qualities of his conception period — Yudhishthira with righteousness, Arjuna with divine skill, Bhima with strength.",
    weekGuide: [
  ...
  },
  {
    ...
    ayurveda:
      "Simantonnayana ceremony performed in Month 7 or 8. In Ayurveda, the baby is now receiving prana directly through the mother's spiritual practice. Increase meditation time. Oil massage with brahmi oil stimulates the baby's neural development.",
    modern:
      "Week 28–30: Baby is fully viable and can survive outside the womb. Week 31–32: All five senses are now active. The baby can taste amniotic fluid influenced by what mother eats and experiences.",
    mantraGuidance:
      "Durga mantra is the ultimate protection mantra. Chanting now covers the baby in a divine shield before the journey into the world. 108 repetitions daily in Month 7–8.",
    gitaVerse:
      'BG 2.20 — "The soul is never born nor dies at any time. It has not come into being, does not come into being, and will not come into being. It is unborn, eternal, ever-existing, and primeval." Your baby is an eternal soul. Have no fear.',
    story:
      "When Uttara was pregnant during the Kurukshetra war and the Brahmastra weapon threatened her womb, Krishna himself entered the womb to protect Parikshit. Divine protection is real and always available. Ask for it.",
    weekGuide: [
  ...
  },
  {
    ...
    ayurveda:
      "In Month 8, the vital essence (ojas) moves between mother and baby. Ayurveda cautions that stress and grief in this month can transfer directly to the baby's constitution. Deep rest, light food, warm spiced milk, and constant devotion.",
    modern:
      "Week 33–34: Baby gains 200–250 grams per week. Week 35–36: Baby is in head-down position preparing for birth. The lungs are almost fully mature. Baby recognises the mother's voice as the most comforting sound.",
    mantraGuidance:
      "Rama mantra — the name that dissolves all karma. As the birth approaches, chanting Rama protects the passage. Mothers in Ayurveda were traditionally surrounded by women chanting when labor began.",
    gitaVerse:
      'BG 18.66 — "Abandon all varieties of religion and just surrender unto Me. I shall deliver you from all sinful reactions. Do not fear." The Lord will deliver this soul safely. Do not fear the birth.',
    story:
      "Devaki sang sacred songs in a prison cell with chains on her wrists. She had no midwives, no luxuries, no support. Yet the most divine being in all of creation emerged from that sacred womb — because her heart was pure.",
    weekGuide: [
  ...
  },
  {
    ...
    ayurveda:
      "The moment of birth is itself a sacred ceremony in Vedic tradition. Immediately after birth: the father whispers 'Hare Krishna' and OM into the baby's right ear. A drop of honey mixed with ghee is placed on the tongue — this is Jatakarma. This programs the child's first experience of taste as sweetness.",
    modern:
      "Week 37–38: Baby is considered full-term. Week 39–40: Baby descends into the birth canal. The first breath expands the lungs and activates the independent nervous system for the first time.",
    mantraGuidance:
      "The Mahamantra is the most complete protection for the moment of birth. Ensure it is playing softly in the birth room. Whisper it yourself if possible. The child's first hearing experience should be the name of God.",
    gitaVerse:
      'BG 2.13 — "As the embodied soul continuously passes, in this body, from boyhood to youth to old age, the soul similarly passes into another body at death. A sober person is not bewildered by such a change." This birth is one chapter in an eternal story.',
    story:
      "At Krishna's own birth, the prison doors flew open, the guards slept, and Vasudeva carried him across the Yamuna at midnight in a storm. A divine serpent shielded them. The universe itself reorganised to ensure his safe arrival. So too will the universe protect this sacred birth.",
    weekGuide: [
...
// ─── Passport Component ───────────────────────────────────────────────────────
// Pink-themed field helper — defined outside component to avoid hooks-in-function issues
...
function SpiritualPassport({
  data,
  onUpdate,
}: { data: PassportData; onUpdate: (d: PassportData) => void }) {
  const [page, setPage] = useState<
    "cover" | "personal" | "celestial" | "blessings"
  >("cover");

  return (
    <div className="relative" style={{ perspective: "1200px" }}>
      <AnimatePresence mode="wait">
        {/* COVER — navy blue like real Indian passport */}
        {page === "cover" && (
          <motion.div
            key="cover"
            ...
            style={{
              background:
                "linear-gradient(160deg, #1A237E 0%, #0D1B6E 40%, #0a1260 100%)",
              border: "3px solid rgba(255,195,77,0.55)",
              boxShadow:
                "0 16px 56px rgba(0,0,0,0.45), 0 0 40px rgba(233,30,140,0.08)",
              minHeight: 360,
            }}
          >
            {/* Gold top trim */}
            <div
              ...
              style={{
                background:
                  "linear-gradient(90deg, #FFB300, #FFD740, #FFC107, #FFD740, #FFB300)",
              }}
            />

            <div className="relative flex flex-col items-center py-8 px-6 text-center">
              {/* Security pattern background */}
              <div
                className="absolute inset-0 opacity-[0.04]"
                style={{
                  backgroundImage:
                    "repeating-linear-gradient(45deg, #FFD740 0px, #FFD740 1px, transparent 1px, transparent 9px)",
                }}
              />
              ...
              {/* Photo placeholder — circular, bordered */}
              <div
        ...
        {page === "personal" && (
          <motion.div
            ...
            style={{
              background:
                "linear-gradient(160deg, rgba(255,240,245,0.98) 0%, rgba(255,228,235,0.98) 100%)",
          ...
          >
            ...
            >
              <p
                ...
                style={{ color: "#E91E8C" }}
              >
                ✦ Blessings from Krishna — BG 2.20
              </p>
              <p
              ...
              >
                ...
                being. It is unborn, eternal, ever-existing, and primeval. It is
            ...
            <label
              ...
              style={{ color: "#C2185B" }}
            >
              Sacred Sankalpa — Parent's Promise to This Soul
            </label>
            <textarea
...
// ─── Main Page ────────────────────────────────────────────────────────────────
export function GarbhaSanskarPage() {
  const [tab, setTab] = useState<
    "journey" | "passport" | "milestones" | "food" | "music"
  >("journey");
  const [passportData, setPassportData] = useState<PassportData>(loadPassport);
  const [peacefulMode, setPeacefulMode] = useState(false);
  const [expandedMonth, setExpandedMonth] = useState<number | null>(1);

  const todayVerse =
    DAILY_VERSES_PREGNANCY[
      new Date().getDate() % DAILY_VERSES_PREGNANCY.length
    ]!;

  function updatePassport(d: PassportData) {
    setPassportData(d);
    try {
  ...
  // Pink lotus page background
  const pageStyle = {
    background:
      "linear-gradient(160deg, #FFF0F5 0%, #FFE4EC 30%, #FFF5F8 65%, #FFEBF3 100%)",
    minHeight: "100vh",
  };
  ...
  return (
    <div className="relative" style={pageStyle}>
      ...
      {peacefulMode && (
        ...
        >
          <div className="max-w-lg w-full px-8 py-10 text-center">
            <p
            ...
            <p className="font-body text-sm mb-1" style={{ color: "#F48FB1" }}>
              {todayVerse.hindi}
            </p>
            <p
      ...
      <div className="max-w-2xl mx-auto px-4 py-5 relative z-20">
        {/* Daily Verse Banner */}
        <motion.div
        ...
        >
          ...
          <p className="font-body text-xs mt-1" style={{ color: "#F48FB1" }}>
            {todayVerse.hindi}
          </p>
          <p
          ...
          <div className="space-y-3">
            ...
            >
              <p
                ...
                style={{ color: "#880E4F" }}
              >
                280-Day Sacred Journey
              </p>
              <p
                className="font-body text-sm italic leading-relaxed"
                style={{ color: "#C2185B", lineHeight: 1.9 }}
              >
                Every day of pregnancy is a sacred gift. The Gita teaches: the
                soul choosing your womb is divine. Fill these 280 days with
                mantra, love, and Krishna's presence. What the mother thinks,
                hears, and feels — the child receives forever.
              </p>
            </div>

            {JOURNEY_MONTHS.map((m, idx) => (
              <motion.div
                key={m.month}
              ...
              >
                ...
                <button
                  ...
                  style={{
                    ...
                    border:
                      expandedMonth === m.month
                        ? "1.5px solid rgba(233,30,140,0.35)"
                      ...
                      <div className="px-2 pb-2 pt-1 space-y-3">
                        ...
                        >
                          ...
                          <div className="space-y-1.5">
                            {m.weekGuide.map((w) => (
                              <div key={w.slice(0, 30)} className="flex gap-2">
                                <span
                ...
                {idx < JOURNEY_MONTHS.length - 1 && <LotusDivider />}
              </motion.div>
            ))}
          </div>
        )}
        ...
        {tab === "passport" && (
          <div>
            <p
              ...
              style={{ color: "#E91E8C" }}
            >
              Fill in your baby's sacred details — all saved privately on this
              device 🪷
            </p>
            <SpiritualPassport data={passportData} onUpdate={updatePassport} />

            <LotusDivider />

            {/* BG 2.20 full blessing */}
            <div
            ...
            >
              <p
                ...
                style={{ color: "#E91E8C" }}
              >
                ✦ Blessings from Krishna — Complete Verse
              </p>
              <p
          ...
          <div className="space-y-3">
            ...
            >
              ...
              <p
                ...
                style={{ color: "#C2185B", lineHeight: 1.85 }}
              >
                Nine sacred milestones — each a threshold where the divine is
                especially close. Mark these in your Baby's Passport.
              </p>
            </div>
            {[
              {
          ...
          <div className="space-y-3">
            ...
            >
              <p
                ...
                style={{ color: "#880E4F" }}
              >
                Sattvic Diet — Sacred Nourishment
              </p>
              <p
                className="font-body text-xs italic"
                style={{ color: "#C2185B", lineHeight: 1.85 }}
              >
                According to the Charaka Samhita and Bhagavad Gita Chapter 17,
                what you eat becomes the child's first prasad. Only sattvic food
                — pure, natural, full of prana, offered mentally to Krishna
                before eating.
              </p>
            </div>
            ...
            >
              <p
                ...
                style={{ color: "#880E4F", lineHeight: 1.85 }}
              >
                ✦ BG 17.8 — "Foods that are juicy, fatty, wholesome, and
                pleasing to the heart are dear to those in the mode of goodness
                and increase the duration of life, purify one's existence and
                give strength, health, happiness and satisfaction."
              </p>
            </div>

            {SATTVIC_FOODS.map((f, i) => (
              <motion.div
                key={f.name}
            ...
            >
              ...
              {[
                ...
                <div key={item.slice(0, 30)} className="flex gap-2 mb-1.5">
                  <span
                    className="text-xs flex-shrink-0"
                    style={{ color: "#E91E8C" }}
                  >
          ...
          <div className="space-y-4">
            ...
            >
              <p
                ...
                style={{ color: "#880E4F" }}
              >
                Sacred Music for the Womb
              </p>
              <p
                className="font-body text-xs italic"
                style={{ color: "#C2185B", lineHeight: 1.85 }}
              >
                Music is the first language of the soul. Ancient Vedic texts
                prescribe specific sounds for each trimester. What the baby
                hears in the womb becomes their deepest nature — not just
                preference, but personality itself.
              </p>
            </div>
            ...
            {[
              {
                ...
                benefit:
                  "The highest vibrational sound in creation. Programs the baby's soul with divine consciousness from birth. Ancient scriptures call this the Maha-mantra — the great mantra that liberates.",
                icon: "🙏",
              },
              {
                ...
                benefit:
                  "1000 names of Vishnu fills the baby's consciousness with divine attributes. Children raised with Sahasranama are reported to have exceptional memory and calm temperament.",
                icon: "🌺",
              },
              {
                ...
                benefit:
                  "The yoga of the Supreme Person. Plants the seed of discrimination (viveka) and wisdom in the forming mind. Abhimanyu learned battle formations this way — what the child hears, they permanently retain.",
                icon: "📖",
              },
              {
                ...
                benefit:
                  "The prayer for illuminated intellect. The Gayatri mantra activates the Ajna chakra — the center of intuition and intelligence. Given at sunrise and sunset for maximum cosmic alignment.",
                icon: "☀️",
              },
              {
                title: "Raga Bhairav",
                ...
                benefit:
                  "The most sacred morning raga. Clears the mental atmosphere. According to classical music texts, Bhairav awakens spiritual consciousness and fills the environment with divine calmness.",
                icon: "🎵",
              },
              {
                title: "Raga Yaman",
                ...
                benefit:
                  "Evening raga of creativity, emotional depth, and peace. The baby absorbs musical patterns even in the womb — this raga helps develop musical sensitivity and emotional intelligence.",
                icon: "🌙",
              },
              {
                ...
                benefit:
                  "The sacred mantra for child blessing. Directly invokes Krishna's grace for the protection and divine nature of the incoming soul. Mothers who chant this report deep peace and confidence.",
                icon: "🪷",
              },
              {
                ...
                benefit:
                  "The Panchakshara mantra of Shiva. Each syllable corresponds to one of the five elements — Na (earth), Ma (water), Shi (fire), Va (air), Ya (space). Balances all five elements in the forming body.",
                icon: "🕉️",
              },
            ].map((item, i) => (
              <motion.div
        ...
        <div className="pb-8 text-center">
          <p
            ...
            style={{ color: "#E91E8C" }}
          >
            🪷 "This soul has chosen you as its earthly guide. You have been
            entrusted with the most sacred responsibility — to nurture a divine
            spark into a dharmic human being. May this child walk in Krishna's
            light always."
          </p>
          <p
            className="font-display text-[0.6rem] font-bold mt-1"
