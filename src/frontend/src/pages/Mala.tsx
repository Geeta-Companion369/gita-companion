...
// ─────────────────────────────────────────────────────────────────────────────
// 18 LIFE-SITUATION MANTRAS — Full Sanskrit, verified and complete
// ─────────────────────────────────────────────────────────────────────────────
...
const MANTRAS_18: MantraData[] = [
  ...
  },
  {
    ...
    meaning:
      "We worship the three-eyed Shiva who nourishes and purifies all. May he liberate us from death as the cucumber is freed from its vine — into immortality. The full Maha-Mrityunjaya with Vyahritis grants liberation to the departed soul and peace to the grieving.",
    benefit:
      "Grants liberation to the departed soul, heals grief, brings divine comfort and strength",
    source: "Rigveda 7.59.12 — complete Maha Mrityunjaya with Vyahritis",
    ttsText:
      "Om Tryambakam Yajamahe Sugandhim Pushtivardhanam Urvarukamiva Bandhanan Mrityor Mukshiya Maamritat Om Shantih Shantih Shantih",
  },
  {
    id: "court-justice",
    ...
    meaning:
      "I bow to Narasimha — the fierce and righteous protector who destroys all injustice. I bow to Varuna, Lord of Justice — I come to you with prayer and offerings, do not be angry, O Varuna, hear my plea — do not shorten my life. Grant me victory in righteous cause.",
    benefit:
      "Divine protection in court and legal matters, victory in righteous cause, justice prevails",
    source: "Narasimha Kavacham + Rigveda 7.86 — Varuna prayer for justice",
    ttsText:
      "Om Kshraum Narasimhaya Namah Om Ugram Viram Mahavishnum Jvalantam Sarvatomukham Nrisimham Bhishanam Bhadram Mrityurmrityum Namamyaham Om Namo Bhagavate Narasimhaya Jvala Jvala Prajvala Prajvala Hrim Hrim Phat Phat Svaha",
  },
  {
    id: "pregnancy-child",
    ...
    meaning:
      "O Krishna, son of Devaki, Govinda — grant me a child, I take refuge in you. Grant progeny, prosperity, long life, and fame. Protect from all evil influences, protect the womb, grant the blessing of a son of good fortune — I bow to you Krishna. Let me be blessed with children. O Gopala, protect me always.",
    benefit:
      "Blesses couples seeking children, protects pregnancy and womb, ensures safe delivery and healthy child",
    source:
      "Santana Gopala Mantra — complete 8 verses — Bhagavata Purana tradition",
    ttsText:
      "Om Shreem Hreem Kleem Glaum Devakisuta Govinda Vasudeva Jagatpate Dehi Me Tanayam Krishna Tvaamaham Sharanam Gatah Om Namo Bhagavate Vasudevaya Putraam Dehi Shriyam Dehi Aayushyam Dehi Yasho Dehi Kleem Krishnaya Govindaya Gopijana Vallabhaya Svaha",
  },
  {
    id: "career-success",
    ...
    meaning:
      "Om — the three realms. We meditate on the divine radiance of Savitr, the sun and cosmic source. May that divine light illuminate and inspire our intellect. Om — waters, light, essence, immortality, Brahman — all three worlds.",
    benefit:
      "Illuminates intellect, opens doors of success, divine clarity for career and decisions",
    source: "Rigveda 3.62.10 — Gayatri Mantra with Vyahriti",
    ttsText:
      "Om Bhur Bhuvah Svah Tat Savitur Varenyam Bhargo Devasya Dhimahi Dhiyo Yo Nah Prachodayat Om Apo Jyoti Rasoamritam Brahma Bhurbhuvah Svarom",
  },
  {
    id: "debt-financial",
    ...
    meaning:
      "O Jatavedas (Fire), bring me Lakshmi — golden-complexioned, beautiful as the moon, wearing gold and silver garlands. Bring that Lakshmi who never departs — through whom I shall obtain gold, cows, horses, and people. Remove all poverty, all misfortune, all lack from my home. Establish Lakshmi permanently in my lineage.",
    benefit:
      "Removes all debt and poverty at its root, establishes permanent prosperity and abundance",
    source: "Rigveda Khila — Shri Suktam, all 15 verses",
    ttsText:
      "Hiranya Varnam Harinim Suvarna Rajata Srajam Chandram Hiranmayim Lakshmim Jatavedo Ma Avaha Tam Ma Avaha Jatavedo Lakshmim Anapagaminim Yasyam Hiranyam Vindeya Gam Ashvam Purushan Aham",
  },
  {
    id: "fear-anxiety",
    ...
    meaning:
      "I bow to the auspicious Shiva — the five syllables represent the five sacred elements of all creation. By chanting Na-Ma-Shi-Va-Ya, one purifies all five elements within. I bow to the eternally auspicious Shiva who leads on the path of auspiciousness.",
    benefit:
      "Purifies the five elements, removes deep fear and anxiety, brings inner stillness and courage",
    source: "Krishna Yajurveda — Shri Rudram 8.13, Shiva Mahapurana",
    ttsText:
      "Om Namah Shivaya Namah Shivaya Shivaya Namah Om Namah Shivaya Shivam Shivakaram Shantam Shivatmanam Shivottamam Shivamarga Pranetaram Pranato Asmi Sadasivam",
  },
  {
    ...
    sanskrit:
      "ॐ इषे एकपदी भव — सा मामनुव्रता भव॥ १॥\nॐ ऊर्जे द्विपदी भव — सा मामनुव्रता भव॥ २॥\nॐ रायस्पोषाय त्रिपदी भव — सा मामनुव्रता भव॥ ३॥\nॐ मायो भवाय चतुष्पदी भव — सा मामनुव्रता भव॥ ४॥\nॐ प्रजाभ्यः पञ्चपदी भव — सा मामनुव्रता भव॥ ५॥\nॐ ऋतुभ्यः षट्पदी भव — सा मामनुव्रता भव॥ ६॥\nॐ सखा सप्तपदी भव — सखायौ स्याव॥ ७॥\n\nसप्तपदी मन्त्र:\nॐ सखे सप्तपदा भव\nत्वया सख्यं करोम्यहम्\nसख्यान्मे पाहि\nसख्यान्मे माऽयोस्थाः॥",
    transliteration:
      "Om Ishe Ekapadi Bhava — Sa Mam Anuvrata Bhava (Step 1: for food)\nOm Urje Dvipadi Bhava — Sa Mam Anuvrata Bhava (Step 2: for strength)\nOm Rayasposhaaya Tripadi Bhava (Step 3: for prosperity)\nOm Mayo Bhavaaya Chatushpadi Bhava (Step 4: for happiness)\nOm Prajabhyah Pancapadi Bhava (Step 5: for children)\nOm Ritubhyah Shatpadi Bhava (Step 6: for all seasons)\nOm Sakha Saptapadi Bhava — Sakhayau Syava (Step 7: friendship, eternal)\n\nOm Sakhe Saptapada Bhava\nTvaya Sakhyam Karomy Aham\nSakhyan Me Pahi\nSakhyan Me Ma Ayosthah",
    meaning:
      "The Seven Steps of the sacred Hindu wedding: for food, for strength, for prosperity, for happiness, for children, for the seasons, and finally — become my eternal friend. With these seven steps, we are united. Be my companion, protect our friendship, never let our bond break.",
    benefit:
      "Sacred union and bond, harmonious marriage, eternal friendship and love",
    source:
      "Rigveda / Grihya Sutras — Vivaha Saptapadi, the seven wedding steps",
    ttsText:
      "Om Ishe Ekapadi Bhava Om Urje Dvipadi Bhava Om Rayasposhaaya Tripadi Bhava Om Mayo Bhavaaya Chatushpadi Bhava Om Prajabhyah Pancapadi Bhava Om Ritubhyah Shatpadi Bhava Om Sakha Saptapadi Bhava Sakhayau Syava",
  },
  {
    id: "health-healing",
    ...
    meaning:
      "I bow to Lord Dhanvantari — avatar of Vasudeva, holding the pot of immortality in his hands, destroyer of all diseases, lord of the three worlds, great Vishnu. I bow to Dhanvantari — the first god, best physician of gods and demons, propounder of Ayurveda, granter of all powers. Whose lotus feet are worshipped by gods and demons, destroyer of all suffering, healer of all diseases, lord of diverse medicines.",
    benefit:
      "Heals all diseases, restores health, brings divine medicine and healing energy",
    source:
      "Ayurveda tradition — complete Dhanvantari Mantra from Bhagavata Purana",
    ttsText:
      "Om Namo Bhagavate Vasudevaya Dhanvantaraye Amritakalasha Hastaya Sarvamaya Vinashanaya Trailokyaathaya Shri Mahavishnave Namah Dhanvantarim Adideuvam Devananca Bhishagvaram Ayurvedasya Pranetaram Namami Siddhidayakam",
  },
  {
    id: "protection-evil",
    ...
    meaning:
      "I bow to mighty Hanuman, son of the wind — swift as thought, equal to the wind, master of the senses, foremost of the wise, chief of vanaras — I take refuge in this messenger of Rama. Let Hanuman guard me from the East, the mighty one from the South, the great warrior from the West, Son of the Wind from the North — may he protect my head, throat, heart, and navel.",
    benefit:
      "Complete divine protection from all evil, negative entities, and harm; Hanuman's armour around the body",
    source:
      "Hanuman Kavach — Tantric Samhita, Hanuman Stotra tradition, Ramcharitmanas",
    ttsText:
      "Om Namo Bhagavate Anjaneyaya Mahabalaya Svaha Manojavam Marutatulyavegam Jitendriyam Buddhimatam Varishtham Vatatmajam Vanarayuthamukhyam Shriramadutam Sharanam Prapadye Om Ham Hanumate Namah Om Ham Hanumate Rudratmakaya Hum Phat",
  },
  {
    ...
    meaning:
      "She who is white as the kunda flower, moon, and snow garland, clothed in pure white, adorned with the vina in her blessed hand, seated on a white lotus — ever worshipped by Brahma, Vishnu, and Shankara — may that Saraswati remove all my dullness. I bow to her who spreads the pure essence of Brahma-vidya throughout the world, who holds vina and books, grants fearlessness, dispels the darkness of ignorance.",
    benefit:
      "Sharpens intellect and memory, removes ignorance, blesses students and scholars with divine wisdom",
    source: "Saraswati Vandana — traditional prayer; Devi Bhagavata Purana",
    ttsText:
      "Ya Kundendu Tushara Hara Dhavala Ya Shubhravastravrita Ya Veenavara Dandamanditakara Ya Shvetapadmasana Ya Brahma Achyuta Shankara Prabhritibhir Devaih Sada Vandita Sa Mam Patu Sarasvati Bhagavati Nihsheshajadyapaha Om Aim Mahasarasvatyai Namah",
  },
  {
    id: "new-venture",
    ...
    meaning:
      "I bow to Ganapati. You alone are the direct Brahman. You alone are the creator, sustainer, and dissolver. You are all this — verily you are Brahman. You are eternal consciousness. Protect me from all sides — front, back, north, south, above, below. You are made of speech, of consciousness, of bliss, of Brahman. You are sat-chit-ananda, non-dual. I bow to Ganesha.",
    benefit:
      "Removes all obstacles from new beginnings, brings divine success and auspiciousness to new ventures",
    source:
      "Ganapati Atharvashirsha Upanishad — Atharva Veda tradition, key verses",
    ttsText:
      "Om Namaste Ganapataye Tvameva Pratyaksham Tattvamasi Ritam Vacmi Satyam Vacmi Ava Tvam Maam Sarvato Mam Pahi Pahi Samantat Tvam Vanmayastvam Chinmayah Tvamanandamayastvam Brahmmayah Om Gam Ganapataye Namah",
  },
  {
    id: "grief-depression",
    ...
    meaning:
      "The soul is never born nor dies — it has not come into being and will not cease to be. It is eternal, unborn, ever-existing, undying, and primeval. When the body is slain the soul is not slain. As a person puts on new garments, so the soul takes on new bodies. Weapons cannot cut it, fire cannot burn it, water cannot wet it, wind cannot dry it. The soul is eternal.",
    benefit:
      "Removes grief at its root with Krishna's eternal wisdom, brings peace about life, death, and loss",
    source: "Bhagavad Gita Chapter 2, Verses 20–23 — Krishna to Arjuna",
    ttsText:
      "Na Jayate Mriyate Va Kadachin Nayam Bhutva Bhavita Va Na Bhuyah Ajo Nityah Shashvato Ayam Purano Na Hanyate Hanyamane Sharire Nainam Chhindanti Shastrani Nainam Dahati Pavakah Na Chainam Kledayanti Apo Na Shoshayati Marutah",
  },
  {
    id: "forgiveness",
    ...
    meaning:
      "Whatever I do with body, speech, mind, senses, intellect, or soul — I offer it all to Narayana. Forgive me for all sins done by hands, feet, speech, body, karma, hearing, sight, or mind — whether prescribed or not — O ocean of compassion, O Mahadeva Shambho. I commit thousands of transgressions every day and night. Knowing I am your servant, please forgive me, O Supreme Lord. I do not know how to invoke you, dismiss you, or worship you properly — please forgive me, O Lord.",
    benefit:
      "Releases all guilt and past karma, brings lightness, peace and divine forgiveness",
    source: "Kshamapana Stotra — traditional Hindu prayer of forgiveness",
    ttsText:
      "Kara Charana Kritam Vak Kayajam Karma Jam Va Shravana Nayana Jam Va Manasam Va Paradham Vihitam Avihitam Va Sarvametat Kshamasva Jaya Jaya Karunaabdhe Shri Mahadeva Shambho Apaadha Sahasrani Kriyante Harnishah Maya Daso Ayam Iti Mam Matva Kshamasva Parameshvara",
  },
  {
    id: "loneliness",
  ...
  },
  {
    ...
    benefit:
      "Empowers self-mastery over addiction, builds inner strength and resolve, reveals the self as its own liberator",
    source:
      "Bhagavad Gita 6.5–6 — Krishna's teaching on self-discipline and liberation",
    ttsText:
      "Uddharedatmana Atmanam Natmanam Avasadayet Atmaiva Hyatmano Bandhur Atmaiva Ripur Atmanah Bandhur Atmatmanas Tasya Yenatmaiva Atmana Jitah Anatmanas Tu Shatritve Varteta Atmaiva Shatruvat Om Namah Shivaya",
  },
  {
    ...
    meaning:
      "We meditate on the divine radiance — may it illuminate our intellect. Om is That. I am Brahman. That thou art. This Self is Brahman. Consciousness is Brahman — the four Mahavakyas. That is complete, this is complete — completeness from completeness, and completeness alone remains. May teacher and student be protected together, nourished together, work with great energy together — may our studies be brilliant, may there be no enmity.",
    benefit:
      "Accelerates spiritual evolution, awakens the highest wisdom, connects to the ultimate reality",
    source:
      "Rigveda 3.62.10 + Four Mahavakyas + Isha Upanishad + Taittiriya Upanishad",
    ttsText:
      "Om Bhurbhuvah Svah Tat Savitur Varenyam Bhargo Devasya Dhimahi Dhiyo Yo Nah Prachodayat Om Tat Sat Om Aham Brahmasmi Om Tat Tvam Asi Om Ayam Atma Brahma Purnamadah Purnamidam Purnat Purnamudacyate Purnasya Purnamadaya Purnamevavashishyate Om Shantih Shantih Shantih",
  },
];
...
function MalaDiagram({ count }: { count: number }) {
  const cx = 160;
  const cy = 160;
  const r = 120;
  return (
    ...
    >
      <title>Sacred mala — {count} of 108 beads counted</title>
      <circle
        cx={cx}
        cy={cy}
        r={r + 18}
      ...
      {BEADS.map(({ id, index }) => {
        ...
        return (
          <motion.circle
            ...
            initial={false}
            animate={
              done ? { opacity: 1, scale: 1 } : { opacity: 0.45, scale: 0.88 }
            }
            transition={{ duration: 0.25 }}
            style={{
              filter: done
                ? "drop-shadow(0 0 3px oklch(0.62 0.18 48 / 0.5))"
                : "none",
            }}
          />
        );
      ...
      <text
        ...
        fontStyle="italic"
      >
        {count >= TOTAL_BEADS ? "Mala Complete" : "Tap to count"}
      </text>
    </svg>
  );
}

function GridVisualization({ count }: { count: number }) {
  return (
    <div>
      <p className="text-verse-number mb-3 text-center">Bead Record</p>
      <div
        ...
        {BEADS.map(({ id, index }) => (
          <motion.div
            ...
            style={{
              background:
                index < count
                  ? "radial-gradient(circle at 35% 35%, oklch(0.72 0.22 50), oklch(0.48 0.18 40))"
                  : "oklch(0.80 0.05 54)",
              border:
                index < count
                  ? "1px solid oklch(0.42 0.16 40)"
                  : "1px solid oklch(0.70 0.06 52)",
              boxShadow:
                index < count
                  ? "0 1px 4px oklch(0.48 0.18 44 / 0.4), inset 0 1px 0 oklch(0.82 0.10 52 / 0.4)"
                  : "none",
            }}
            initial={false}
            animate={
...
function SessionEntry({ session }: { session: MalaSession }) {
  return (
    <div
  ...
  return (
    <motion.button
      ...
      style={{
        ...
        background: isSelected
          ? "linear-gradient(135deg, oklch(0.89 0.09 56 / 0.95), oklch(0.86 0.11 52 / 0.9))"
          : "oklch(0.92 0.06 60 / 0.55)",
        border: isSelected
          ? "1.5px solid oklch(0.62 0.16 48)"
          : "1px solid oklch(0.78 0.08 52 / 0.5)",
        borderRadius: "3px",
        boxShadow: isSelected
          ? "0 2px 10px oklch(0.58 0.18 48 / 0.18), inset 0 1px 0 rgba(255,248,220,0.4)"
          : "none",
    ...
    >
      <div className="flex items-center gap-2 mb-1 flex-wrap">
        <span className="text-base leading-none">{mantra.emoji}</span>
        <span
...
function ActiveMantraPanel({
  ...
  onSpeak,
  isSpeaking,
}: { mantra: MantraData; onSpeak: () => void; isSpeaking: boolean }) {
  return (
    <motion.div
      key={mantra.id}
      ...
      style={{
        background:
          "linear-gradient(160deg, oklch(0.94 0.07 62 / 0.95) 0%, oklch(0.90 0.09 56 / 0.9) 100%)",
        border: "1.5px solid oklch(0.70 0.14 50 / 0.5)",
        borderRadius: "3px",
        boxShadow:
          "0 4px 20px oklch(0.48 0.16 44 / 0.12), inset 0 1px 0 rgba(255,248,220,0.5)",
    ...
    >
      <div className="flex items-start justify-between gap-3 mb-4 flex-wrap">
        <div>
          <div className="flex items-center gap-2 mb-0.5">
            <span className="text-xl">{mantra.emoji}</span>
            <p
      ...
      {/* Sanskrit — ALWAYS VISIBLE, complete */}
      <div
      ...
      >
        <span>{isSpeaking ? "⏹ Stop" : "🔊 Listen to Mantra"}</span>
      </button>
    </motion.div>
  );
}
...
export function MalaPage() {
  ...
  const selectedMantra =
    MANTRAS_18.find((m) => m.id === selectedMantraId) ?? MANTRAS_18[0];
  ...
  return (
    <div className="max-w-2xl mx-auto pb-16">
      ...
      >
        ...
        <p className="text-verse-number mb-2">Sacred Practice</p>
        <h1 className="chapter-header">Digital Japa Mala</h1>
        <p className="text-translation mt-2 mx-auto max-w-md">
          18 mantras for every season of life. Full Sanskrit always visible.
          Choose your mantra, chant 108 times, and draw the mind toward the
          Divine.
        </p>
      ...
      {/* 18 LIFE-SITUATION MANTRA SELECTION */}
      <motion.div
        className="mb-6"
      ...
      >
        ...
        >
          <div className="flex items-center justify-between mb-3 flex-wrap gap-2">
            ...
            >
              ✦ Choose Your Mantra — 18 Life Situations
            </p>
            {sessionStarted && count > 0 && (
              <p
                className="font-body text-xs italic"
                style={{ color: "oklch(0.52 0.08 50)" }}
              >
                — Complete or reset to change
              </p>
            )}
          </div>
          <div
      ...
      >
        <div
          ...
          style={{
            background:
              "radial-gradient(ellipse at 50% 15%, oklch(0.93 0.07 60 / 0.8) 0%, oklch(0.88 0.09 55 / 0.6) 100%)",
            border: "1px solid oklch(0.72 0.08 52 / 0.4)",
            borderRadius: "3px",
            boxShadow:
              "inset 0 0 60px oklch(0.18 0.04 44 / 0.06), 0 2px 12px rgba(80,55,30,0.10)",
          }}
        >
          {[
            "top-2 left-3",
          ...
          <p className="text-verse-number mb-1">{selectedMantra.name}</p>
          <p
          ...
          {/* Sanskrit always visible during japa */}
          <div
          ...
          <div className="flex items-center gap-3 justify-center mt-5 flex-wrap">
        ...
        >
          ...
          >
            <div className="flex items-center justify-between mb-4">
              <p className="text-verse-number">Japa Record</p>
              <p
                className="font-body text-xs italic"
                style={{ color: "oklch(0.52 0.10 48)" }}
              >
                {totalBeads} total sacred beads counted
              </p>
            </div>
            <div>
      ...
      <Dialog open={showCelebration} onOpenChange={handleCelebrationClose}>
        <DialogContent
          ...
          style={{
            background:
              "radial-gradient(ellipse at 50% 0%, oklch(0.93 0.07 60) 0%, oklch(0.88 0.09 55) 100%)",
            border: "2px solid oklch(0.62 0.14 48 / 0.6)",
            borderRadius: "2px",
            boxShadow:
              "0 8px 40px rgba(80,55,30,0.3), inset 0 1px 0 rgba(255,248,220,0.35)",
          }}
        >
          <motion.div
          ...
          >
            ...
            <div>
              ...
              >
                108 sacred beads counted · Hare Krishna 🙏
              </p>
            </div>
            <div className="divider-ornate">
              <span>॥</span>
