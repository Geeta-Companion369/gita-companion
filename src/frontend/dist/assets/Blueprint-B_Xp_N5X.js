const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/jspdf.es.min-Cs73hFyb.js","assets/index-DqMoqjqS.js","assets/index-C5c0CeOS.css"])))=>i.map(i=>d[i]);
import { u as useNavigate, r as reactExports, j as jsxRuntimeExports, m as motion, _ as __vitePreload } from "./index-DqMoqjqS.js";
const SECTIONS = [
  {
    id: "first-time",
...
const PATHWAYS = [
  ...
  },
  {
    ...
    screens: [
      ...
      {
        heading: "Screens 6.3–6.6 — Varna / Sankalp Tracker / Ekadashi / Annual Fasts",
  ...
  },
  {
    ...
    screens: [
      {
        heading: "Screens 10.1–10.3 — Entry / 21-Day Challenge / Personal Journal",
  ...
  },
  {
    ...
    screens: [
      ...
      {
        heading: "Screens 19.3–19.6 — Graha Shanti / Gemstone / Transit / Weekly",
  ...
  },
  {
    ...
    screens: [
      {
        heading: "Screens 21.1–21.4 — Entry / Questions / Mapping / Dharma Statement",
...
async function generateBlueprintPDF() {
  const { jsPDF } = await __vitePreload(async () => {
    const { jsPDF: jsPDF2 } = await import("./jspdf.es.min-Cs73hFyb.js").then((n) => n.j);
    return { jsPDF: jsPDF2 };
  ...
  const textW = W - ML - MR;
  let pageNum = 1;
  const GOLD = [198, 153, 43];
  const SAFFRON = [217, 119, 6];
  const DARK_GOLD = [146, 64, 14];
  const CREAM = [255, 248, 231];
  const PARCHMENT = [245, 222, 179];
  const INK = [34, 20, 10];
  const LAPIS = [63, 81, 181];
  ...
  function divider(y2) {
    ...
    pdf.line(ML, y2, W - MR, y2);
    pdf.setFontSize(9);
    pdf.setTextColor(...SAFFRON);
    pdf.setFont("helvetica", "normal");
    pdf.text("✦ ——— ✦", W / 2, y2 + 4, { align: "center" });
    return y2 + 8;
  }
  pdf.setFillColor(...CREAM);
  pdf.rect(0, 0, W, H, "F");
  ...
  function writeSectionHeader(title, icon) {
    checkPageBreak(20);
    pdf.setFillColor(...PARCHMENT);
  ...
  function writeHeading(text, color = SAFFRON) {
    checkPageBreak(12);
    pdf.setFontSize(10);
  ...
  function writePathwayHeader(num, title, icon, _color) {
    checkPageBreak(22);
    pdf.setFillColor(...GOLD);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      style: {
        ...
        background: "linear-gradient(160deg, oklch(0.97 0.06 70 / 0.98) 0%, oklch(0.95 0.08 64 / 0.98) 100%)"
      },
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            style: {
              background: "linear-gradient(135deg, oklch(0.94 0.12 56 / 0.97) 0%, oklch(0.91 0.16 50 / 0.97) 100%)",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-4 py-3 space-y-3", children })
      ]
    }
  );
}
function ScreenItem({ heading, body }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
                  ...
                  children: pathway.num
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { fontSize: "1.1rem" }, children: pathway.icon }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "h2",
                {
                  className: "font-display font-bold italic",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-4 py-3 space-y-2.5", children: pathway.screens.map((screen, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          ScreenItem,
          {
...
function DownloadButton({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    motion.button,
    {
      ...
      style: {
        background: loading ? "oklch(0.78 0.18 54)" : "linear-gradient(135deg, oklch(0.78 0.34 54), oklch(0.65 0.28 46))",
        color: "oklch(0.10 0.06 28)",
        fontSize: "0.88rem",
        boxShadow: loading ? "none" : "0 4px 18px oklch(0.78 0.34 54 / 0.45), 0 0 24px oklch(0.82 0.36 54 / 0.22)",
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "button",
                {
                  ...
                  children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-body", children: "Menu" })
                  ]
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "p",
                {
                  ...
                  children: "Complete App Blueprint"
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "p",
                {
                  ...
                  children: "All 21 Sacred Pathways — Full Screen-to-Text Format"
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(DownloadButton, { onDownload: handleDownload, loading: pdfLoading }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
                  ...
                  style: {
                    height: "2px",
                    maxWidth: "380px",
                    background: "linear-gradient(90deg, transparent, oklch(0.78 0.34 54), oklch(0.65 0.28 46), oklch(0.78 0.34 54), transparent)"
                  }
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { id: "blueprint-content", className: "space-y-1 px-1", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            motion.div,
            {
              initial: { opacity: 0, y: 12 },
              ...
              style: {
                background: "linear-gradient(160deg, oklch(0.95 0.12 58 / 0.97) 0%, oklch(0.92 0.16 50 / 0.97) 100%)",
                border: "2px solid oklch(0.78 0.30 52 / 0.55)",
                boxShadow: "0 8px 36px oklch(0.78 0.34 54 / 0.25), inset 0 1px 0 rgba(255,248,210,0.8)"
              },
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: { fontSize: "2.5rem", lineHeight: 1 }, children: "ॐ" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "p",
                  {
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "p",
                  {
                    ...
                    children: "This blueprint contains the complete screen-by-screen specification for all 21 Sacred Pathways. Every feature, every screen, every detail — documented for the final build."
                  }
                ),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "p",
                  {
                    ...
                    children: "✦ May 2026 · Sanatan Dharma - Krishna AI ✦"
                  }
                )
              ]
            }
          ),
          SECTIONS.map((section, si) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            motion.div,
            {
              initial: { opacity: 0, y: 10 },
              animate: { opacity: 1, y: 0 },
              transition: { delay: 0.15 + si * 0.07, duration: 0.4 },
              children: /* @__PURE__ */ jsxRuntimeExports.jsx(SectionCard, { title: section.title, icon: section.icon, children: section.items.map((item, ii) => (
                // biome-ignore lint/suspicious/noArrayIndexKey: static content
                /* @__PURE__ */ jsxRuntimeExports.jsx(ScreenItem, { heading: item.heading, body: item.body }, ii)
              )) })
            },
            section.id
          )),
          PATHWAYS.map((pathway, pi) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            motion.div,
            {
              initial: { opacity: 0, y: 10 },
              animate: { opacity: 1, y: 0 },
              transition: { delay: 0.2 + pi * 0.03, duration: 0.4 },
              children: /* @__PURE__ */ jsxRuntimeExports.jsx(PathwayCard, { pathway })
            },
            pathway.id
          )),
          CLOSING_SECTIONS.map((section, ci) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            motion.div,
            {
              initial: { opacity: 0, y: 10 },
              animate: { opacity: 1, y: 0 },
              transition: { delay: 0.5 + ci * 0.07, duration: 0.4 },
              children: /* @__PURE__ */ jsxRuntimeExports.jsx(SectionCard, { title: section.title, icon: section.icon, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                "p",
                {
                  className: "font-body leading-relaxed whitespace-pre-line",
                  style: { fontSize: "0.75rem", color: "oklch(0.22 0.08 36)" },
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "p",
                  {
                    ...
                    children: '\\"Whenever dharma declines... I manifest myself.\\" — Bhagavad Gita 4:7'
                  }
                ),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "p",
                  {
                    ...
                    children: "✦ Sanatan Dharma - Krishna AI ✦ May 2026 ✦"
                  }
                )
              ]
            }
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex justify-center mt-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx(DownloadButton, { onDownload: handleDownload, loading: pdfLoading }) })
      ]
    }
  );
}
