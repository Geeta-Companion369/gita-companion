...
async function noopDownload(data) {
...
function getBackend() {
  ...
  const canisterId = typeof process !== "undefined" ? define_process_env_default.CANISTER_ID_BACKEND : void 0;
  if (!canisterId || canisterId === "undefined") {
    _client = mockBackend;
    return _client;
  }
  _client = createActor(canisterId, noop, noopDownload);
  return _client;
}
export {
  getBackend as g
