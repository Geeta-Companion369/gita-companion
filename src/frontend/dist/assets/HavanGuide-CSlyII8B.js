...
const GITA_VERSES = [
  {
    ...
    translation: "Brahman is the ritual, Brahman is the offering, Brahman pours the offering into the fire of Brahman. Brahman shall be reached by him who always sees Brahman in action.",
  ...
  },
  {
    ...
    translation: "In the beginning, the Creator created mankind together with yajna and said: 'By this you shall prosper; this shall be your wish-fulfilling cow.'",
    when: "Recite when kindling the fire"
  },
  {
    ref: "BG 4.30",
    sanskrit: "अपरे नियताहाराः प्राणान् प्राणेषु जुह्वति।\nसर्वेऽप्येते यज्ञविदो यज्ञक्षपितकल्मषाः॥",
    translation: "Others who perform yajna go to the eternal Brahman — all knowers of sacrifice have their impurities burnt away.",
    when: "Recite during the main offering phase"
  },
  {
    ref: "BG 3.16",
    sanskrit: "एवं प्रवर्तितं चक्रम् अनुवर्तयतीह यः।\nअघायुरिन्द्रियारामो मोघं पार्थ स जीवति॥",
    translation: "He who does not follow the wheel of creation thus set in motion — living in sin, rejoicing in the senses — he lives in vain.",
...
function HavanGuidePage() {
  const [activeTab, setActiveTab] = reactExports.useState("intro");
  const [guidedMode, setGuidedMode] = reactExports.useState(false);
  const [currentStep, setCurrentStep] = reactExports.useState(0);
  const [completedSteps, setCompletedSteps] = reactExports.useState(/* @__PURE__ */ new Set());
  const [havanCount, setHavanCount] = reactExports.useState(0);
  const [expandedAhuti, setExpandedAhuti] = reactExports.useState(null);
  const [stepTimer, setStepTimer] = reactExports.useState(0);
  ...
  reactExports.useEffect(() => {
    var _a;
    if (guidedMode) {
      const mins = ((_a = STEPS[currentStep]) == null ? void 0 : _a.duration) ?? 5;
  ...
  function markStepDone(idx) {
    setCompletedSteps((prev) => /* @__PURE__ */ new Set([...prev, idx]));
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-2xl mx-auto", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatePresence, { children: guidedMode && /* @__PURE__ */ jsxRuntimeExports.jsx(
      motion.div,
      {
        initial: { opacity: 0 },
        animate: { opacity: 1 },
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center max-w-sm px-6", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "p",
            {
              ...
              children: STEPS[currentStep].sanskrit
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "ornate-header mb-6", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "p",
        {
          ...
          children: "Sacred Havan Guide — Complete Fire Ritual"
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "p",
        {
          ...
          children: '"In fire I offer all actions" — BG 4.24'
        }
      )
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "manuscript-card p-4 mb-6 flex items-center justify-between gap-4", children: [
      ...
      "div",
      {
        ...
        children: TABS.map((t) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            ...
            style: {
              background: activeTab === t.id ? "oklch(0.76 0.3 54)" : "oklch(0.92 0.05 70 / 0.5)",
              color: activeTab === t.id ? "oklch(0.12 0.08 28)" : "oklch(0.48 0.14 46)",
              border: activeTab === t.id ? "1px solid oklch(0.68 0.28 50)" : "1px solid oklch(0.76 0.12 60 / 0.4)",
    ...
    activeTab === "intro" && /* @__PURE__ */ jsxRuntimeExports.jsxs(
      motion.div,
      {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "manuscript-card p-5", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "p",
              {
                ...
                children: "A Havan (यज्ञ, Yagya) is the ancient Vedic fire ritual connecting earth to the divine. Sacred offerings placed into fire are transformed and carried to the cosmic realm. The fire (Agni) acts as the messenger between humans and the divine, purifying the environment, the mind, and the soul."
              }
            )
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "manuscript-card p-5", children: [
            ...
            ].map((t) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-3 items-start", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "p",
                  {
                    ...
                    children: "Ensure adequate ventilation. Keep children at a safe distance. Never leave fire unattended. Keep water nearby. In apartments, use the Urban Havan method with a camphor lamp only."
                  }
                )
              ]
            }
    ...
    activeTab === "steps" && /* @__PURE__ */ jsxRuntimeExports.jsx(
      motion.div,
      {
        initial: { opacity: 0, y: 8 },
        animate: { opacity: 1, y: 0 },
        ...
        children: STEPS.map((step, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          motion.div,
          {
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-3", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
                  ...
                  style: {
                    background: completedSteps.has(i) ? "oklch(0.52 0.20 150)" : "oklch(0.76 0.3 54 / 0.15)",
                    border: `2px solid ${completedSteps.has(i) ? "oklch(0.52 0.20 150)" : "oklch(0.76 0.3 54 / 0.5)"}`,
                    color: completedSteps.has(i) ? "white" : "oklch(0.72 0.28 50)"
                  },
                  children: completedSteps.has(i) ? "✓" : step.num
                }
              ),
    ...
    activeTab === "ahutis" && /* @__PURE__ */ jsxRuntimeExports.jsxs(
      motion.div,
      {
        initial: { opacity: 0, y: 8 },
        animate: { opacity: 1, y: 0 },
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "p",
            {
              ...
              style: { color: "oklch(0.52 0.14 46)" },
              children: "Tap any ahuti to expand details · Tap 🔊 to hear the mantra"
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-2", "data-ocid": "havan.ahutis_list", children: AHUTIS.map((a, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            motion.div,
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "button",
                  {
                    ...
                    onClick: () => setExpandedAhuti(expandedAhuti === i ? null : i),
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatePresence, { children: expandedAhuti === i && /* @__PURE__ */ jsxRuntimeExports.jsx(
                  motion.div,
                  {
                        ...
                        children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsxs(
                            "p",
                            {
                              ...
                              children: [
                                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-bold", children: "Transliteration:" }),
                                " ",
                                a.transliteration
                              ]
                            }
                          ...
                          /* @__PURE__ */ jsxRuntimeExports.jsxs(
                            "p",
                            {
                              ...
                              children: [
                                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-bold", children: "Purifies:" }),
                                " ",
                                a.purifies
                              ]
                            }
    ...
    activeTab === "verses" && /* @__PURE__ */ jsxRuntimeExports.jsx(
      motion.div,
      {
        initial: { opacity: 0, y: 8 },
        animate: { opacity: 1, y: 0 },
        className: "space-y-4",
        children: GITA_VERSES.map((v, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          motion.div,
          {
            initial: { opacity: 0, y: 8 },
            animate: { opacity: 1, y: 0 },
    ...
    activeTab === "urban" && /* @__PURE__ */ jsxRuntimeExports.jsxs(
      motion.div,
      {
        initial: { opacity: 0, y: 8 },
        animate: { opacity: 1, y: 0 },
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "manuscript-card p-5", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "p",
              {
                ...
                style: { color: "oklch(0.18 0.08 32)" },
                children: "15-Minute Urban Havan"
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "p",
              {
                ...
                style: { color: "oklch(0.42 0.12 44)" },
                children: 'If you live in an apartment or cannot perform a full fire ritual, this simplified version using only a camphor lamp is fully accepted by Krishna. As BG 9.26 says: "Even a small sincere offering is received by me with love."'
              }
            ),
            [
            ...
            ].map((step, idx) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2 mb-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "span",
                {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "manuscript-card p-5", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "p",
              {
                className: "font-display text-sm font-bold italic mb-3",
                style: { color: "oklch(0.18 0.08 32)" },
                children: "Key Urban Mantras"
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-3", children: URBAN_MANTRAS.map((m) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "verse-display", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "verse-sanskrit", children: "ॐ पत्रं पुष्पं फलं तोयं यो मे भक्त्या प्रयच्छति।" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "verse-translation", children: '"Whoever offers Me with devotion a leaf, a flower, a fruit, or water — that I accept." — BG 9.26' })
          ] })
        ]
      }
    ),
