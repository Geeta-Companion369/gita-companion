const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/jspdf.es.min-WNSKaFNp.js","assets/index-CodWPqWB.js","assets/index-C7pLd5vW.css"])))=>i.map(i=>d[i]);
import { u as useNavigate, r as reactExports, j as jsxRuntimeExports, m as motion, _ as __vitePreload } from "./index-CodWPqWB.js";
const SECTIONS = [
  {
    id: "first-time",
...
async function generateBlueprintPDF() {
  const { jsPDF } = await __vitePreload(async () => {
    const { jsPDF: jsPDF2 } = await import("./jspdf.es.min-WNSKaFNp.js").then((n) => n.j);
    return { jsPDF: jsPDF2 };
